...
class NewGroupClient extends React.Component {
  ...
  getAllUsers = () => {
    ...
    dispatch(
      administrationActions.getAllUsers(
        RoleSearchTypeConstants.Account_Officers_only
      )
    );
  };
  ...
  handleCreateNewGroup = async (createNewCustomerpayload) => {
    ...
    await dispatch(
      clientsActions.createClient(createNewCustomerpayload, "group")
    );
  };
              ...
              <Form.Row>
                <Col>
                  ...
                  <ReactTooltip id="registerTip" place="right" effect="float">
                    The number issued to the group during registration with
                    government.
                  </ReactTooltip>{" "}
                  <Form.Control
              ...
              <Accordion defaultActiveKey="3">
                ...
                <Accordion.Collapse eventKey="3">
                  <div className="each-formsection">
                    ...
                    {allMembersList.length >= 1 && this.renderAllMembersList()}
                  </div>
                </Accordion.Collapse>
              </Accordion>
              <Accordion defaultActiveKey="3">
                ...
                <Accordion.Collapse eventKey="3">
                  <div className="each-formsection">
                    ...
                    {allMembersList.length >= 1 && this.renderAllMembersRoles()}
                  </div>
                </Accordion.Collapse>
              </Accordion>
