...
class BranchListManagement extends React.Component {
  ...
  fetchForEmptyState = () => {
    ...
    console.log(
      "fetchForEmptyState: " + adminGetAllBranchesRequest.request_status
    );
  ...
  fetchErrorState() {
    ...
    console.log(
      "fetchErrorState: " + adminGetAllBranchesRequest.request_status
    );
    switch (adminGetAllBranchesRequest.request_status) {
    ...
    return (
      <div>
          ...
          <Form className="one-liner">
            <div className="table-helper mb-10">
              <input
                ...
                checked={this.state.FullDetails??false}
                id="showFullDetails"
              />
        ...
        <div className="footer-with-cta toleft">
          <NavLink
            to={"/administration/organization/newbranch"}
                  ...
                  <div className="lowerlevel-menu">
                    <ul className="nav">
                      <li>
                        ...
                        <NavLink exact to={"/administration/organization"}>
                          Branches
                        </NavLink>
                      </li>
                      {/* <li>
