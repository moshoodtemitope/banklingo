...
class RiskLevels extends React.Component {
  ...
  createNewRecordPopUp = () => {
    ...
    let checkValidationSchema = Yup.object().shape({
      ...
      fromDays: Yup.string().required('Required'),
      toDays: Yup.string().required('Required'),
      percentageProvision: Yup.string().required('Required'),
    });
    return (
      <Modal
      ...
      >
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              let requestPayload = {
                ...
                percentageProvision: parseFloat(
                  values.percentageProvision.replace(/,/g, '')
                ),
              };

              this.createNewRecord(requestPayload).then(() => {
                if (
                  this.props.createARiskLevel.request_status ===
                  administrationConstants.ADD_A_RISK_LEVEL_SUCCESS
                ) {
                  resetForm();
                  this.loadInitialData();
                }
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <Form.Row>
                    ...
                    <Col>
                      ...
                      <Form.Control
                        ...
                        className={
                          errors.percentageProvision &&
                          touched.percentageProvision
                            ? 'is-invalid h-38px'
                            : 'h-38px'
                        }
                  ...
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={createARiskLevelRequest.is_request_processing}
                    >
                      {createARiskLevelRequest.is_request_processing
                        ? 'Please wait...'
                        : 'Create'}
                    </Button>
                  </div>
          ...
          {createARiskLevelRequest.request_status ===
            administrationConstants.ADD_A_RISK_LEVEL_SUCCESS && (
          ...
          {createARiskLevelRequest.request_status ===
            administrationConstants.ADD_A_RISK_LEVEL_FAILURE && (
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              if (this.state.updateType === 'activate') {
                requestPayload = {
                  ...
                  percentageProvision: parseFloat(
                    recordToUpdate.percentageProvision.replace(/,/g, '')
                  ),
                  objectState: 0,
                };
              }
              ...
              this.updateARecord(
                ...
                if (
                  this.props.updateARiskLevel.request_status ===
                  administrationConstants.UPDATE_A_RISK_LEVEL_SUCCESS
                ) {
                  this.loadInitialData();
                }
              });
                ...
                <Form noValidate onSubmit={handleSubmit}>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => {
                          if (this.state.updateType !== 'edit') {
                            setFieldValue(
                              'percentageProvision',
                              recordToUpdate.percentageProvision
                            );
                          } else {
                            setFieldValue(
                              'percentageProvision',
                  ...
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={updateARiskLevelRequest.is_request_processing}
                    >
                      {updateARiskLevelRequest.is_request_processing &&
                        'Please wait...'}
                      {!updateARiskLevelRequest.is_request_processing &&
          ...
          {updateARiskLevelRequest.request_status ===
            administrationConstants.UPDATE_A_RISK_LEVEL_SUCCESS && (
            <Alert variant='success'>
          ...
          {updateARiskLevelRequest.request_status ===
            administrationConstants.UPDATE_A_RISK_LEVEL_FAILURE && (
            <Alert variant='danger'>
  ...
  renderContentWrap = () => {
    ...
    let saveRequestData =
      fetchAllRiskLevelRequest.request_data !== undefined
        ? fetchAllRiskLevelRequest.request_data.tempData
        : null;
    ...
    switch (fetchAllRiskLevelRequest.request_status) {
                    ...
                    return (
                      <Fragment key={index}>
                        <tr>
                          <td>{eachItem.name}</td>
                          <td>
                            {eachItem.fromDays} to {eachItem.toDays} days
                          </td>
      ...
      case administrationConstants.GET_ALL_RISK_LEVEL_SUCCESS:
        let allFetchedData =
          fetchAllRiskLevelRequest.request_data.response.data;
