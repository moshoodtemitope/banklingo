...
import {
  clientsActions,
  clientsConstants,
} from "../../redux/actions/clients/clients.action";
...
import {
  CLIENTS_MODULE_MENU_LINKS,
  GROUP_MODULE_MENU_LINKS,
} from "../../shared/config";
...
class ClientsListDisplay extends React.Component {
  ...
  retrieveFromApi = (tempData) => {
    ...
    let { PageSize, CurrentPage, BranchId, FullDetails } = this.state;
  ...
  getHeaderDescription = () => {
    ...
    switch (this.props.clientState) {
      case ClientStateConstants.PENDING_APPROVAL:
        return <div>Customers (Pending Approval)</div>;
      case ClientStateConstants.ACTIVE:
        return <div>Customers (Active)</div>;
      case ClientStateConstants.INACTIVE:
        return <div>Customers (In-Active)</div>;
      case ClientStateConstants.ALL_CLIENTS:
        return <div>Customers (All)</div>;

      case ClientStateConstants.EXITED:
        return <div>Customers (Exited)</div>;
      case ClientStateConstants.BLACKLISTED:
        return <div>Customers (Blacklisted)</div>;
  ...
  fetchForDataState = () => {
    ...
    switch (getClientsRequest.request_status) {
      case clientsConstants.GET_CLIENTS_SUCCESS:
        ...
        let allClientsData =
          getClientsRequest.request_data !== undefined
            ? getClientsRequest?.request_data?.response?.data
            : null;
        ...
        <div className="heading-with-cta ">
          ...
          >
            <Form.Group controlId="filterDropdown" className="no-margins pr-10">
              <Form.Control as="select" size="sm" className="tableFilterInput">
        ...
        <InnerPageContainer {...this.props}>
          <div className="content-wrapper">
            <div className="module-heading">
              ...
              <SubMenu
                links={CLIENTS_MODULE_MENU_LINKS}
                key={this.props.clientState}
              />
