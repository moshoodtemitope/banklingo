                    ...
                    if (this.state.isSubmitable) {
                      ...
                      loanAccountPayload = {
                        ...
                        rescheduleDetails: {
                          ...
                          reducedPrincipal: parseFloat(
                            values.outstandingPrincipal.replace(/,/g, '')
                          ),
                      ...
                      this.rescheduleLoanAccount(loanAccountPayload).then(
                        () => {
                          if (
                            this.props.rescheduleALoanReducer.request_status ===
                            loanAndDepositsConstants.RESCHEDULE_LOAN_SUCCESS
                          ) {
                            setTimeout(() => {
                              // resetForm();
                              // this.props.dispatch(loanActions.rescheduleALoan("CLEAR"))
                  ...
                  {({
                    ...
                    >
                      <div className='form-heading'>
                        <h3>
                          Rescheduling Loan Account ({loanData.accountNumber})
                        </h3>
                      </div>
                      <Form.Row>
                        {customerFetchedData !== undefined &&
                            ...
                            <Form.Row>
                              <Col>
                                ...
                                <Form.Control
                                  ...
                                  // onChange={handleChange}
                                  onChange={(e) => {
                                    delete this.loanSchedulePayload
                                      .reschdeuleInfo.interestBalance;
                                    this.loanSchedulePayload.reschdeuleInfo.interestBalance = parseFloat(
                              ...
                              <Col>
                                ...
                                <Form.Control
                                  ...
                                  // onChange={handleChange}
                                  onChange={(e) => {
                                    this.loanSchedulePayload.reschdeuleInfo.outstandingFees = parseFloat(
                                      e.target.value.replace(/,/g, '')
                                    );
                                    setFieldValue(
                                      'outstandingFees',
                            ...
                            <Form.Row>
                              <Col sm={6}>
                                ...
                                <Form.Control
                                  ...
                                  autoComplete='off'
                                  onChange={(e) => {
                                    this.loanSchedulePayload.reschdeuleInfo.outstandingPenalty = parseFloat(
                                      e.target.value.replace(/,/g, '')
                                    );
                                    setFieldValue(
                                      'outstandingPenalty',
                            ...
                            <Form.Row>
                              <Col>
                                ...
                                <Form.Control
                                  ...
                                  // onChange={handleChange}
                                  onChange={(e) => {
                                    this.loanSchedulePayload.reschdeuleInfo.outstandingPrincipal = parseFloat(
                                      e.target.value.replace(/,/g, '')
                                    );
                                    setFieldValue(
                                  ...
                                  <input
                                    ...
                                    onChange={(event) => {
                                      ...
                                      if (event.target.checked === true) {
                                        ...
                                        if (
                                          parseFloat(
                                            values.outstandingPrincipal.replace(
                                              /,/g,
                                              ''
                                            )
                                          ) < loanData.outstandingPrincipal
                          ...
                          <div className='each-formsection'>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                this.loanSchedulePayload.reschdeuleInfo.interestBalance =
                                  values.interestBalance;
                                this.loanSchedulePayload.reschdeuleInfo.outstandingFees =
                                  values.outstandingFees;
                                this.loanSchedulePayload.reschdeuleInfo.outstandingPenalty =
                                  values.outstandingPenalty;
                                this.loanSchedulePayload.reschdeuleInfo.outstandingPrincipal =
                                  values.outstandingPrincipal;
                      ...
                      <div className='footer-with-cta toleft'>
                        ...
                        <Button
                          type='submit'
                          disabled={
                            rescheduleALoanRequest.is_request_processing
                          }
                        >
                          {rescheduleALoanRequest.is_request_processing
                            ? 'Please wait...'
                      ...
                      {rescheduleALoanRequest.request_status ===
                        loanAndDepositsConstants.RESCHEDULE_LOAN_FAILURE && (
                        <Alert className='mt-20' variant='danger'>
                          {rescheduleALoanRequest.request_data.error}{' '}
                        </Alert>
                      )}
                      ...
                      {rescheduleALoanRequest.request_status ===
                        ...
                        <Alert className='mt-20' variant='success'>
                          {rescheduleALoanRequest.request_data.response.data
                            .message || 'Reschedule was successful'}{' '}
                        </Alert>
                      )}
                    </Form>
                  )}
