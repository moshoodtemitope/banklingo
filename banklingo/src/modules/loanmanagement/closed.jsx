...
//     dispatch(loanActions.getClosedLoans(paramters));
//   };
...
//     if (tempData) {
//       dispatch(loanActions.getClosedLoans(params, tempData));
//     } else {
//       dispatch(loanActions.getClosedLoans(params));
//     }
//   };
...
//     }
//     let params = `PageSize=${PageSize}&CurrentPage=${CurrentPage}&StartDate=${startDate}&endDate=${endDate}&SearchText=${SearchText}&LoanState=7`;
...
//   return {
//     getLoansRequest: state.loansReducers.getClosedLoansReducer,
//   };
// }
