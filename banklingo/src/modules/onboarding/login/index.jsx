...
//     if (
//       getRouteForRedirect().getPreviousRoute !== undefined &&
//       getRouteForRedirect().getPreviousRoute !== null
//     ) {
...
//               this.handleLoginForm(loginPayload).then(() => {
...
//                 // setTimeout(() => {
//                 if (
//                   this.props.loginRequest.request_status ===
//                   authConstants.LOGIN_USER_SUCCESS
//                 ) {
...
//                   >
//                     {loginRequest.is_request_processing
//                       ? 'Please wait...'
//                       : 'Log In'}
//                   </Button>
...
//                 {loginRequest.request_status ===
//                   authConstants.LOGIN_USER_FAILURE && (
//                   <Alert variant='danger mt-20'>
//                     {loginRequest.request_data.error !== undefined
//                       ? loginRequest.request_data.error
//                       : null}
//                   </Alert>
//                 )}
//                 {this.redirectType !== null &&
//                   this.redirectType === 'timeout' &&
//                   loginRequest.request_status !==
//                     authConstants.LOGIN_USER_FAILURE &&
//                   loginRequest.request_status !==
//                     authConstants.LOGIN_USER_PENDING &&
//                   loginRequest.request_status !==
//                     authConstants.LOGIN_USER_SUCCESS && (
//                     <Alert variant='danger mt-20'>
...
//                 {this.redirectType !== null &&
//                   this.redirectType === 'unauthorized' &&
//                   loginRequest.request_status !==
//                     authConstants.LOGIN_USER_FAILURE &&
//                   loginRequest.request_status !==
//                     authConstants.LOGIN_USER_PENDING &&
...
//   render() {
//     return <Fragment>{this.renderLoginForm()}</Fragment>;
//   }
// }
