...
class ManageBankInfo extends React.Component {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              if (selectedCustomer !== '') {
                ...
                this.createNewRecord(requestPayload).then(() => {
                  if (
                    this.props.createBankInfoReducer.request_status ===
                    platformConstants.ADD_A_BANKINFO_SUCCESS
                  ) {
                    resetForm();
                    this.loadInitialData();
                  }
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={createBankInfoRequest.is_request_processing}
                    >
                      {createBankInfoRequest.is_request_processing
                        ? 'Please wait...'
                        : 'Create'}
                    </Button>
                  </div>
          ...
          {createBankInfoRequest.request_status ===
            platformConstants.ADD_A_BANKINFO_SUCCESS && (
          ...
          {createBankInfoRequest.request_status ===
            platformConstants.ADD_A_BANKINFO_FAILURE && (
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              this.updateARecord(
                ...
                if (
                  this.props.updateBankInfoReducer.request_status ===
                  platformConstants.UPDATE_A_BANKINFO_SUCCESS
                ) {
                  this.loadInitialData();
                }
              });
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={updateBankInfoRequest.is_request_processing}
                    >
                      {updateBankInfoRequest.is_request_processing &&
                        'Please wait...'}
                      {!updateBankInfoRequest.is_request_processing &&
          ...
          {updateBankInfoRequest.request_status ===
            platformConstants.UPDATE_A_BANKINFO_SUCCESS && (
            <Alert variant='success'>
          ...
          {updateBankInfoRequest.request_status ===
            platformConstants.UPDATE_A_BANKINFO_FAILURE && (
            <Alert variant='danger'>
  ...
  renderContentWrap = () => {
    ...
    let saveRequestData =
      fetchAllBankInfoRequest.request_data !== undefined
        ? fetchAllBankInfoRequest.request_data.tempData
        : null;
    ...
    return (
      <Fragment>
        <InnerPageContainer {...this.props}>
          {this.props.fetchAllBankInfoReducer.request_status ===
            platformConstants.GET_ALL_BANKINFO_SUCCESS &&
...
function mapStateToProps(state) {
  return {
    ...
    fetchSingleBankInfoReducer:
      state.platformReducers.fetchSingleBankInfoReducer,
