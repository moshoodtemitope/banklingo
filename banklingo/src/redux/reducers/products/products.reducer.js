...
export function getSingleLoanFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.GET_A_LOAN_FEE_PENDING:
      return {
        request_status: productsConstants.GET_A_LOAN_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.GET_A_LOAN_FEE_SUCCESS:
      return {
        request_status: productsConstants.GET_A_LOAN_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.GET_A_LOAN_FEE_FAILURE:
      return {
        request_status: productsConstants.GET_A_LOAN_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
...
export function createLoanFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.CREATE_A_LOAN_PRODUCT_FEE_PENDING:
      return {
        request_status: productsConstants.CREATE_A_LOAN_PRODUCT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.CREATE_A_LOAN_PRODUCT_FEE_SUCCESS:
      return {
        request_status: productsConstants.CREATE_A_LOAN_PRODUCT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.CREATE_A_LOAN_PRODUCT_FEE_FAILURE:
      return {
        request_status: productsConstants.CREATE_A_LOAN_PRODUCT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.CREATE_A_LOAN_PRODUCT_FEE_RESET:
      return {
        request_status: productsConstants.CREATE_A_LOAN_PRODUCT_FEE_RESET,
        is_request_processing: false,
        request_data: {},
      };
...
export function updateLoanFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.EDIT_A_LOAN_PRODUCT_FEE_PENDING:
      return {
        request_status: productsConstants.EDIT_A_LOAN_PRODUCT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.EDIT_A_LOAN_PRODUCT_FEE_SUCCESS:
      return {
        request_status: productsConstants.EDIT_A_LOAN_PRODUCT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.EDIT_A_LOAN_PRODUCT_FEE_FAILURE:
      return {
        request_status: productsConstants.EDIT_A_LOAN_PRODUCT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.EDIT_A_LOAN_PRODUCT_FEE_RESET:
      return {
        request_status: productsConstants.EDIT_A_LOAN_PRODUCT_FEE_RESET,
        is_request_processing: false,
        request_data: {},
      };
...
export function deleteLoanFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.DELETE_A_LOAN_PRODUCT_FEE_PENDING:
      return {
        request_status: productsConstants.DELETE_A_LOAN_PRODUCT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.DELETE_A_LOAN_PRODUCT_FEE_SUCCESS:
      return {
        request_status: productsConstants.DELETE_A_LOAN_PRODUCT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.DELETE_A_LOAN_PRODUCT_FEE_FAILURE:
      return {
        request_status: productsConstants.DELETE_A_LOAN_PRODUCT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.DELETE_A_LOAN_PRODUCT_FEE_RESET:
      return {
        request_status: productsConstants.DELETE_A_LOAN_PRODUCT_FEE_RESET,
        is_request_processing: false,
        request_data: {},
      };
...
export function getDepositFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.GET_A_DEPOSIT_FEE_PENDING:
      return {
        request_status: productsConstants.GET_A_DEPOSIT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.GET_A_DEPOSIT_FEE_SUCCESS:
      return {
        request_status: productsConstants.GET_A_DEPOSIT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.GET_A_DEPOSIT_FEE_FAILURE:
      return {
        request_status: productsConstants.GET_A_DEPOSIT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
...
export function createDepositFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_PENDING:
      return {
        request_status: productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_SUCCESS:
      return {
        request_status: productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_FAILURE:
      return {
        request_status: productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_RESET:
      return {
        request_status: productsConstants.CREATE_A_DEPOSIT_PRODUCT_FEE_RESET,
        is_request_processing: false,
        request_data: {},
      };
...
export function deleteDepositFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_PENDING:
      return {
        request_status: productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_SUCCESS:
      return {
        request_status: productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_FAILURE:
      return {
        request_status: productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_RESET:
      return {
        request_status: productsConstants.DELETE_A_DEPOSIT_PRODUCT_FEE_RESET,
        is_request_processing: false,
        request_data: {},
      };
...
export function updateDepositProductFeeReducer(state = [], action) {
  switch (action.type) {
    case productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_PENDING:
      return {
        request_status: productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_PENDING,
        is_request_processing: true,
        request_data: action,
      };
    case productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_SUCCESS:
      return {
        request_status: productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_SUCCESS,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_FAILURE:
      return {
        request_status: productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_FAILURE,
        is_request_processing: false,
        request_data: action,
      };
    case productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_RESET:
      return {
        request_status: productsConstants.EDIT_A_DEPOSIT_PRODUCT_FEE_RESET,
        is_request_processing: false,
        request_data: {},
      };
