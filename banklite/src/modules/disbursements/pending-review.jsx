...
class DisbursementPendingReview extends React.Component {
  ...
  approveOrRejectReviewedDisbursementRequest = async (actionPayload) => {
    ...
    await dispatch(
      disbursementActions.approveOrRejectReviewedDisbursement(actionPayload)
    );
  };
  ...
  setPagesize = (PageSize, tempData) => {
    ...
    if (tempData) {
      dispatch(
        disbursementActions.getPendingReviewDisbursement(params, tempData)
      );
    } else {
  ...
  renderFullDetails = (transactionToProcess) => {
    ...
    let approveOrRejectReviewedDisbursementRequest = this.props
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              this.approveOrRejectReviewedDisbursementRequest(
                processPayload
              ).then(() => {
                if (
                  this.props.approveOrRejectReviewedDisbursementReducer
                    .request_status ===
                  disbursmentConstants.APPROVE_OR_REJECT_REVIEWED_DISBURSMENT_SUCCESS
                ) {
                  const { dispatch } = this.props;
                  ...
                  setTimeout(() => {
                    resetForm();
                    dispatch(
                      disbursementActions.getPendingReviewDisbursement(
                        params,
                        saveRequestData
                      )
                    );
                    this.props.dispatch(
                      disbursementActions.approveOrRejectReviewedDisbursement(
                        'CLEAR'
                      )
                    );
                    this.handleClose();
                  ...
                  if (
                    this.props.approveOrRejectReviewedDisbursementReducer
                      .request_status ===
                    disbursmentConstants.APPROVE_OR_REJECT_REVIEWED_DISBURSMENT_FAILURE
                  ) {
                    setTimeout(() => {
                      resetForm();
                    }, 2000);
          ...
          >
            {({
              ...
              <Form noValidate onSubmit={handleSubmit}>
                ...
                {approveOrRejectReviewedDisbursementRequest.request_status !==
                  disbursmentConstants.APPROVE_OR_REJECT_REVIEWED_DISBURSMENT_SUCCESS && (
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={
                        approveOrRejectReviewedDisbursementRequest.is_request_processing
                      }
                    >
                      {approveOrRejectReviewedDisbursementRequest.is_request_processing &&
          ...
          {approveOrRejectReviewedDisbursementRequest.request_status ===
            ...
            <Alert variant='success'>
              {
                approveOrRejectReviewedDisbursementRequest.request_data.response
                  .data.message
              }
            </Alert>
          )}
                            ...
                            <td>
                              ...
                              >
                                <NavLink
                                  ...
                                  to={`/disbursements/pending-review/${eachDisburment.batchReference}`}
                                >
                                  View Batch
                                </NavLink>
            ...
            >
              ...
              {allUSerPermissions.indexOf('bnk_review_disbursements') > -1 &&
                approveOrRejectReviewedDisbursementRequest.request_status ===
                  ...
                  <Alert variant='success'>
                    {
                      approveOrRejectReviewedDisbursementRequest.request_data
...
function mapStateToProps(state) {
  return {
    getDisbursementsReducer:
      state.disbursmentReducers.getPendingReviewDisbursementReducer,
    approveOrRejectReviewedDisbursementReducer:
      state.disbursmentReducers.approveOrRejectReviewedDisbursementReducer,
