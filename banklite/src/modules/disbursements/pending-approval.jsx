...
class DisbursementPendingApproval extends React.Component {
  ...
  getDisbursements = (paramters) => {
    ...
    dispatch(
      disbursementActions.getPendingApprovalDisbursement(paramters, true)
    );
  };
  ...
  approveOrRejectPostDisbursementRequest = async (actionPayload) => {
    ...
    await dispatch(
      disbursementActions.approveOrRejectPostDisbursement(actionPayload)
    );
  };
  ...
  rejectDisburmentRequest = async (rejectionPayload) => {
    ...
    await dispatch(
      disbursementActions.rejectPostDisbursement(rejectionPayload)
    );
  };
  ...
  renderFullDetails = (transactionToProcess) => {
    ...
    let approveOrRejectPostDisbursementRequest = this.props
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              this.approveOrRejectPostDisbursementRequest(processPayload).then(
                () => {
                  if (
                    this.props.approveOrRejectPostDisbursementReducer
                      .request_status ===
                    disbursmentConstants.APPROVE_OR_REJECT_DISBURSMENT_SUCCESS
                  ) {
                    const { dispatch } = this.props;
                    ...
                    let getDisbursementsRequest = this.props
                    ...
                    setTimeout(() => {
                      resetForm();
                      dispatch(
                        disbursementActions.getDisbursement(
                          params,
                          saveRequestData
                        )
                      );
                      this.props.dispatch(
                        disbursementActions.approveOrRejectPostDisbursement(
                          'CLEAR'
                        )
                      );
                      this.handleClose();
                    ...
                    if (
                      this.props.approveOrRejectPostDisbursementReducer
                        .request_status ===
                      disbursmentConstants.APPROVE_OR_REJECT_DISBURSMENT_FAILURE
                    ) {
                      resetForm();
                    }
                    // setTimeout(() => {
          ...
          >
            {({
              ...
              <Form noValidate onSubmit={handleSubmit}>
                      ...
                      <Form.Row>
                        ...
                        <Col>
                          ...
                          <span className='form-text disabled-field'>
                            {transactionToProcess.sourceAccount}
                          </span>
                        </Col>
                        <Col></Col>
                      </Form.Row>
                    ...
                    <div>
                      <Form.Row>
                        <Col>
                          <Form.Group>
                            ...
                            <span className='form-text disabled-field'>
                              {transactionToProcess.destinationBank}
                            </span>
                          </Form.Group>
                        </Col>
                        <Col>
                          <Form.Group>
                            ...
                            <span className='form-text disabled-field'>
                              {transactionToProcess.destinationAccount}
                            </span>
                          </Form.Group>
                        </Col>
                      </Form.Row>
                      <Form.Row>
                        <Col>
                          ...
                          <span className='form-text disabled-field'>
                            {numberWithCommas(transactionToProcess.amount)}
                          </span>
                        </Col>
                        <Col>
                ...
                {approveOrRejectPostDisbursementRequest.request_status !==
                  disbursmentConstants.APPROVE_OR_REJECT_DISBURSMENT_SUCCESS && (
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      type='submit'
                      onClick={() =>
                        this.setState({ actionToPerform: 'approve' })
                      }
                      disabled={
                        approveOrRejectPostDisbursementRequest.is_request_processing
                      }
                    >
                      {approveOrRejectPostDisbursementRequest.is_request_processing &&
                      this.state.actionToPerform === 'approve'
                        ? 'Please wait...'
                        : 'Approve'}
                    </Button>
                    ...
                    <Button
                      type='submit'
                      onClick={() =>
                        this.setState({ actionToPerform: 'reject' })
                      }
                      disabled={
                        approveOrRejectPostDisbursementRequest.is_request_processing
                      }
                    >
                      {approveOrRejectPostDisbursementRequest.is_request_processing &&
                      this.state.actionToPerform === 'reject'
                        ? 'Please wait...'
                        : 'Reject'}
                    </Button>
                  </div>
          ...
          {approveOrRejectPostDisbursementRequest.request_status ===
            ...
            <Alert variant='success'>
              {
                approveOrRejectPostDisbursementRequest.request_data.response
                  .data.message
              }
            </Alert>
          )}
  ...
  searchTxtn = (e, tempData) => {
    ...
    if (SearchText !== '' || endDate !== '' || startDate !== '') {
      ...
      if (tempData) {
        dispatch(
          disbursementActions.getPendingApprovalDisbursement(params, tempData)
        );
      } else {
                            ...
                            <td>
                              ...
                              >
                                <NavLink
                                  ...
                                  to={`/disbursements/pending-approval/${eachDisburment.batchReference}`}
                                >
                                  View Batch
                                </NavLink>
        ...
        >
          {({
            ...
            >
                  ...
                  <div>
                    <Form.Row>
                      <Col xs={6}>
                        ...
                        <span className='form-text disabled-field'>
                          {transactionToProcess.senderName}
                        </span>
                      </Col>
                      <Col xs={6}>
                        <Form.Label className='block-level'>
                  ...
                  <div>
                    ...
                    <Form.Row>
                      <Col xs={6}>
                        ...
                        <span className='form-text disabled-field'>
                          {transactionToProcess.recipientName}
                        </span>
                      </Col>
                      <Col xs={6}>
              ...
              {allUSerPermissions.indexOf('bnk_approve_disburmsements') >
                -1 && (
                <Accordion defaultActiveKey='0'>
                  <Accordion.Toggle
                    className='accordion-headingLink'
              ...
              {allUSerPermissions.indexOf('bnk_approve_disburmsements') > -1 &&
                approveOrRejectPostDisbursementRequest.request_status !==
                  disbursmentConstants.APPROVE_OR_REJECT_DISBURSMENT_SUCCESS && (
                  <div>
              ...
              {allUSerPermissions.indexOf('bnk_approve_disburmsements') > -1 &&
                approveOrRejectPostDisbursementRequest.request_status ===
                  ...
                  <Alert variant='success'>
                    {
                      approveOrRejectPostDisbursementRequest.request_data
...
function mapStateToProps(state) {
  return {
    getDisbursementsReducer:
      state.disbursmentReducers.getPendingApprovalDisbursementReducer,
    approveOrRejectPostDisbursementReducer:
      state.disbursmentReducers.approveOrRejectPostDisbursementReducer,
    rejectPostDisbursementReducer:
      state.disbursmentReducers.rejectPostDisbursementReducer,
  };
}
