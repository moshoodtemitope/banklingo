...
class NipRequests extends React.Component {
  ...
  renderInWardsRequest = () => {
    ...
    let saveRequestData =
      getInwardsNIPRequestData.request_data !== undefined
        ? getInwardsNIPRequestData.request_data.tempData
        : null;
    if (
      getInwardsNIPRequestData.request_status ===
      disbursmentConstants.GET_NIP_INWARDS_PENDING
    ) {
...
<span className="invalid-feedback">{errors.startDate}</span>
                  ...
                  return (
                    <Fragment key={index}>
                      <tr>
                        ...
                        <td>
                          {getDateFromISO(eachRequest.transactionDate, true)}
                        </td>
    ...
    if (
      getInwardsNIPRequestData.request_status ===
      disbursmentConstants.GET_NIP_INWARDS_SUCCESS
    ) {
      let allNIPRequestData =
        getInwardsNIPRequestData.request_data.response.data;
...
<span className="invalid-feedback">{errors.startDate}</span>
    ...
    if (
      getInwardsNIPRequestData.request_status ===
      disbursmentConstants.GET_NIP_INWARDS_FAILURE
    ) {
      return (
