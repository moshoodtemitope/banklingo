                                    ...
                                    this.handleCreateNewCustomer(createNewCustomerPayload)
                                        .then(
                                            () => {
                                                ...
                                                if (this.props.createAClient.request_status === administrationConstants.CREATE_CUSTOMERTYPE_SUCCESS) {
                                                    resetForm();
                                                }
                                        ...
                                        <Form 
                                            ...
                                            <div className="footer-with-cta toleft">
                                                {/* <Button variant="light" className="btn btn-light">
                                                    Cancel</Button> */}
                                                <NavLink to={'/administration/active-clients'} className="btn btn-secondary grayed-out">Cancel</NavLink>
