...
class EditAClient extends React.Component {
  ...
  renderUpdateCustomer = () => {
    ...
    let updateACustomerValidationSchema = Yup.object().shape({
      ...
      employmentDate: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      officialEmail: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      monthlySalary: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      employeeSector: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      employeeSubSector: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      payDay: Yup.number().when("workStatus", {
        is: "1",
        then: Yup.number().required("Required"),
      }),
      employerAddress: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      employerAddressState: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
      employerAddressCity: Yup.string().when("workStatus", {
        is: "1",
        then: Yup.string().required("Required"),
      }),
        ...
        return (
          <Formik
            initialValues={{
              ...
              dateOfBirth:
                allCustomerData.dateOfBirth !== undefined &&
                  ...
                  <Form.Row>
                    ...
                    <Col>
                      ...
                      <Select
                        ...
                        defaultValue={{
                          label: selectedCustype.name,
                          value: selectedCustype.encodedKey,
                        }}
