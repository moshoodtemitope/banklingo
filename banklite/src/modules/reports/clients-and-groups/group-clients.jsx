...
class GroupClientReports extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      user: '',
  ...
  exportReport = (ExportFileType) => {
    ...
    let paramters = `GroupTypeId=${ClientTypeId}&ClientState=${ClientState}&ExportFileType=${ExportFileType}&StartDate=${startDate}&EndDate=${endDate}`;
    ...
    return (
      ...
      <div className='heading-with-cta'>
        ...
        >
            ...
            <Form.Group>
              <label htmlFor='toshow' className="mr-10">Group Type</label>
              <select
                id='toshow'
                onChange={(e) =>
...
export default connect(mapStateToProps)(GroupClientReports);
