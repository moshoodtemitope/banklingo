...
class TrialBalanceAnalysisReports extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      user: '',
      ...
      reportType:"trialbalanceanalysis",
...
export default connect(mapStateToProps)(TrialBalanceAnalysisReports);
