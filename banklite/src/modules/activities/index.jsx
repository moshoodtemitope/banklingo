...
class Activties extends React.Component {
  ...
  renderActivities = () => {
    ...
    let saveRequestData =
      getActivitiesRequestData.request_data !== undefined
        ? getActivitiesRequestData.request_data.tempData
        : null;
    if (
      getActivitiesRequestData.request_status ===
      dashboardConstants.GET_ACTIVITIES_DATA_PENDING
    ) {
...
<span className="invalid-feedback">{errors.startDate}</span>
    ...
    if (
      getActivitiesRequestData.request_status ===
      dashboardConstants.GET_ACTIVITIES_DATA_SUCCESS
    ) {
      let allActivitiesData =
        getActivitiesRequestData.request_data.response.data;
          ...
          return (
            <div>
              <div className='heading-with-cta'>
                <Form
                  className='one-liner'
                  onSubmit={(e) => this.searchTxtn(e, allActivitiesData.result)}
                >
                  <Form.Group
                    controlId='filterDropdown'
                    className='no-margins pr-10'
...
<span className="invalid-feedback">{errors.startDate}</span>
                ...
                <div className='pagination-wrap'>
                  ...
                  <select
                    id='toshow'
                    onChange={(e) =>
                      this.setPagesize(e, allActivitiesData.result)
                    }
                    value={this.state.PageSize}
                    className='countdropdown form-control form-control-sm'
                  >
...
<span className="invalid-feedback">{errors.startDate}</span>
    ...
    if (
      getActivitiesRequestData.request_status ===
      dashboardConstants.GET_ACTIVITIES_DATA_FAILURE
    ) {
      return (
