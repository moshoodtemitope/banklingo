...
class NewInvestmentCustomerAccount extends React.Component {
    constructor(props) {
        super(props);
        this.state={
            user:''
                                            ...
                                            <div className="full-pageforms w-60">
                                                <Form className="form-content card">
                                                    <div className="form-heading">
                                                        <h3>Creating A Investment Customer</h3>
                                                    </div>
                                                    ...
                                                    <div className="footer-with-cta toleft">
                                                        ...
                                                        <Button>Create Investment Customer</Button>
                                                    </div>
                                                </Form>
                                                {/* <div className="footer-with-cta toleft">
...
export default NewInvestmentCustomerAccount;