...
// export class WithdrawLoanModal extends React.Component {
//     constructor(props) {
//         super(props);
...
//     const { changeLoanState, newState, newStateUpdate, showDisburseLoanForm } = this.state;
...
//                                             <span className="form-text">Closed(Withdrawn)</span>
//                                         </Col>
//                                     </Form.Row>
//                                 </Form.Group>
//                                 <Form.Group>
...
//                             >
//                                 {changeLoanStateRequest.is_request_processing ? "Please wait..." : `Withdraw`}
...
// export default connect(mapStateToProps)(WithdrawLoanModal);