  ...
  render() {
    ...
    return (
      <Modal
        ...
        size="lg"
        centered="true"
        dialogClassName="modal-50w withcentered-heading"
        animation={false}
      >
        <Formik
          initialValues={{
                    ...
                    <Col className="date-wrap">
                      <Form.Group className="table-helper m-b-5">
                        <input
                          ...
                          onChange={handleChange}
                          checked={
                            values.allowBackDate ? values.allowBackDate : false
                          }
                          value={values.allowBackDate}
                          id="allowBackDate"
                        />
                        <label htmlFor="allowBackDate">
                          Do you want to Backdate transaction?
                        </label>
                      </Form.Group>
                    ...
                    <Col className="date-wrap">
                      <Form.Group className="table-helper m-b-5">
                        <input
                          ...
                          id="showBookingDate"
                        />
                        <label htmlFor="showBookingDate">
                          Do you want to set Booking Date?
                        </label>
                      </Form.Group>
                      {values.showBookingDate === true && (
                        <Form.Group className="mb-0 date-wrap">
                          ...
                          <DatePicker
                            ...
                            maxDate={new Date()}
                            className={
                              errors.bookingDateChosen &&
                              touched.bookingDateChosen
                                ? "is-invalid form-control form-control-sm h-38px"
                                : "form-control h-38px form-control-sm"
                            }
                            customInput={
