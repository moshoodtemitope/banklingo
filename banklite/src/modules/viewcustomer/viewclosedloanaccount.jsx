            ...
            <div>
                <div className="amounts-wrap w-65">
                    <div className="eachamount">
                        <h6>Account State</h6>
                        <div className="amounttext">Closed ({loanAccountData.loanStateDescription})</div>
                    </div>
                    {/* <div className="eachamount">
                        <h6>Total Balance</h6>
                                ...
                                <Modal.Body>
                                        ...
                                        <div>
                                            <Form.Row>
                                                <Col>
                                                    ...
                                                    <h5>CurCode{getAClientLoanAccountRequest.request_data.response.data.loanAmount}</h5>
                                                </Col>
                                                <Col>
...

                                    {
                                        ...
                                        <div>
                                            <Form.Row>
                                                <Col>
                                                    <Form.Label className="block-level">Amount to repay (CurCode)</Form.Label>
                                                    <Form.Control
                                                        type="text"
                                                        autoComplete="off"
                                                        onChange={handleChange}
