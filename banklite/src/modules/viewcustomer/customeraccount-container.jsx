...
class CustomerAccountContainer extends React.Component {
  ...
  handleSetNotificationClose = () =>
    this.setState({ showSetNotification: false });

  handleSetNotificationShow = () =>
    this.setState({ showSetNotification: true });
  ...
  setNotificationBox = () => {
    ...
    return (
      <Modal
        ...
        onHide={this.handleSetNotificationClose}
        size='lg'
        centered='true'
        dialogClassName='modal-40w withcentered-heading'
        animation={false}
  ...
  changeHistoryBox = () => {
    ...
    return (
      <Modal
        ...
        onHide={this.handleChangeHistoryClose}
        size='lg'
        centered='true'
      ...
      <div className='heading-ctas'>
        <ul className='nav'>
          {allUSerPermissions.indexOf('bnk_manage_clients_task') > -1 && (
            <li>
              <Button size='sm' onClick={this.handleTaskShow}>
                New Task
              </Button>
            </li>
          )}
