...
class ViewCustomer extends React.Component {
    ...
    if (this.isFileImage(file)) {
      ...
      reader.addEventListener(
        ...
        () => {
          ...
          this.setState({
            previewSignatureStyles: preViewStyle,
    ...
    if (this.isFileImage(file)) {
      ...
      reader.addEventListener(
        ...
        () => {
          ...
          this.setState({
            previewPhotoStyles: preViewStyle,
            imageData: reader.result,
          });
        },
        false
      ...
      <div className="slidein-wrap">
        ...
        <div className="slidein-form" ref={this.setWrapperRef}>
          <div className="slide-in-heading">
            ...
            <div className="close-slidein" onClick={this.closeAddSignature}>
              X
            </div>
          </div>
          ...
          <div className="slidein-formwrap">
            <div className="upload-wrap">
              <label
                ...
                style={previewSignatureStyles}
              >
                {!previewSignatureStyles && <div>Upload Passport Photo</div>}
              </label>
              {previewSignatureStyles && <small>Change uploaded image</small>}
              <input
                type="file"
                name=""
                accept="image/*"
              ...
              {invalidImageUpload && (
                <Alert variant="danger">Please upload a valid image</Alert>
              )}
            </div>

            <div className="footer-with-cta mb-20">
              {addAClientSignatureReducer.request_status !==
                clientsConstants.ADD_A_CLIENT_SIGNATURE_SUCCESS && (
                <Button
                  type="submit"
                ...
                >
                  {addAClientSignatureReducer.is_request_processing
                    ? "Please wait..."
                    : "Upload"}
                </Button>
              )}
            ...
            {addAClientSignatureReducer.request_status ===
              ...
              <Alert variant="success">
                {addAClientSignatureReducer.request_data.response.data
                  .message &&
                  addAClientSignatureReducer.request_data.response.data.message}
                {!addAClientSignatureReducer.request_data.response.data
                  .message && "Signature was uploaded"}
              </Alert>
            )}
            {addAClientSignatureReducer.request_status ===
              clientsConstants.ADD_A_CLIENT_SIGNATURE_FAILURE && (
    ...
    return (
      <div className="slidein-wrap">
        ...
        <div className="slidein-form" ref={this.setWrapperRef}>
          <div className="slide-in-heading">
            <h3>Upload Photo</h3>
            <div className="close-slidein" onClick={this.closeAddPhoto}>
              X
            </div>
          </div>
          ...
          <div className="slidein-formwrap">
            <div className="upload-wrap">
              ...
              >
                {!previewPhotoStyles && <div>Upload Photo</div>}
              </label>
              {previewPhotoStyles && (
                <small>Click the photo to upload another one</small>
              )}
              <input
                type="file"
                name=""
              ...
              {invalidImageUpload && (
                <Alert variant="danger">Change uploaded image.</Alert>
              )}
            </div>

            <div className="footer-with-cta mb-20">
              {addAClientPassportReducer.request_status !==
                clientsConstants.ADD_A_CLIENT_PASSPORT_SUCCESS && (
                <Button
                  type="submit"
                ...
                >
                  {addAClientPassportReducer.is_request_processing
                    ? "Please wait..."
                    : "Upload"}
                </Button>
              )}
            ...
            {addAClientPassportReducer.request_status ===
              clientsConstants.ADD_A_CLIENT_PASSPORT_SUCCESS && (
              <Alert variant="success">
                {addAClientPassportReducer.request_data.response.data.message &&
                  addAClientPassportReducer.request_data.response.data.message}
                {!addAClientPassportReducer.request_data.response.data
                  .message && "Photo was uploaded"}
              </Alert>
            )}
            {addAClientPassportReducer.request_status ===
              clientsConstants.ADD_A_CLIENT_PASSPORT_FAILURE && (
              <Alert variant="danger">
  ...
  renderCustomerActivities = () => {
    ...
    if (
      getAClientActivitiesRequest.request_status ===
      clientsConstants.GET_A_CLIENT_ACTIVITIES_PENDING
    ) {
    ...
    if (
      getAClientActivitiesRequest.request_status ===
      clientsConstants.GET_A_CLIENT_ACTIVITIES_SUCCESS
    ) {
      let customerActivitiesData =
        getAClientActivitiesRequest.request_data.response.data;
    ...
    if (
      getAClientActivitiesRequest.request_status ===
      clientsConstants.GET_A_CLIENT_ACTIVITIES_FAILURE
    ) {
      return (
  ...
  renderPage = () => {
    ...
    if (
      ...
      let customerTypeVal = this.state.user.custTypes.filter(
...
function mapStateToProps(state) {
  return {
    ...
    getAClientActivitiesReducer:
      state.clientsReducers.getAClientActivitiesReducer,
    ...
    addAClientSignatureReducer:
      state.clientsReducers.addAClientSignatureReducer,
