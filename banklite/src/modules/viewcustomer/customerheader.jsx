...
class CustomerHeading extends React.Component {
    constructor(props) {
        ...
        this.state={
            user:'',
            generatedRoutes :{
                customer: `/customer/${this.props.customerId}`,
                attachments: `/customer/${this.props.customerId}/attachments`,
                tasks: `/customer/${this.props.customerId}/tasks`,
                communications: `/customer/${this.props.customerId}/communications`,
                comments: `/customer/${this.props.customerId}/comments`,
                // loanaccount: `/customer/${this.props.customerId}/loan/${this.props.loanId}`,
                            ...
                            <div className="module-submenu">
                                <div className="content-container">
                                    <ul className="nav">
                                        ...
                                        <li>
                                            <NavLink to={generatedRoutes.loanaccount}>Payroll- Private 348046272</NavLink>
                                        </li>
                                        <li>
