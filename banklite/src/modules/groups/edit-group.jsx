...
class EditAGroup extends React.Component {
  ...
  handleSelectedCustomer = (inputValue) => {
    ...
    if(allExistingMembers.length>0) return;
        ...
        return (
          <Formik
            initialValues={{
              ...
              businessNumber: allCustomerData.businessNumber,
              taxId: allCustomerData.taxId,
...
<InputGroup className="mb-3">
                  ...
                  <Form.Control
                  aria-describedby="group-name-addon"
                    type="text"
                    name="groupName"
                    onChange={handleChange}
                    value={values.groupName}
                    ...
                    required
                  />
                  <InputGroup.Append><InputGroup.Text id="group-name-addon"> <Badge variant="primary">{values.clientCode}</Badge> </InputGroup.Text></InputGroup.Append>
                  </InputGroup>
                      {errors.groupName && touched.groupName ? (
