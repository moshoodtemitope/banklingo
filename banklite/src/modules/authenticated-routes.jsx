...
import DepositProductChargesContainer from "./view-depositproduct/depositCharges-container";

import LoanProductInfoContainer from "./view-loanproduct/product-container";
import LoanProductChargesContainer from "./view-loanproduct/loanCharges-container";
        ...
        <Router history={history}>
          <Switch>
            ...
            <Route
              exact
              path="/"
              render={(props) => <LoginWrap {...this.props} />}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_create_client"
              exact
              path="/clients/new/:customertype/:custTypeid"
              authed={this.props.user}
              component={NewClient}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_create_client"
              exact
              path="/groups/new/:customertype/:custTypeid"
              authed={this.props.user}
              component={NewGroupClient}
            />
            <PrivateRoute
              accessRequired="bnk_create_client"
              exact
            ...
            <Route
              exact
              path="/clients/new"
              render={(props) => <NewClient {...this.props} />}
            />

            <PrivateRoute
              accessRequired="bnk_edit_client"
              exact
              path="/clients/edit/:encodedkey"
              authed={this.props.user}
              component={EditAClient}
            />
            <PrivateRoute
              accessRequired="bnk_edit_client"
              exact
              path="/group/edit/:encodedkey"
              authed={this.props.user}
              component={EditAGroup}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_clients"
              exact
              path="/clients"
              {...this.props}
              authed={this.props.user}
              clientState={ClientStateConstants.ALL_CLIENTS}
              component={ClientsListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_clients"
              exact
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              clientState={ClientStateConstants.ACTIVE}
              component={ClientsListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_clients"
              ...
              {...this.props}
              authed={this.props.user}
              clientState={ClientStateConstants.INACTIVE}
              component={ClientsListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_clients"
              exact
              path="/clients-pending-approval"
              {...this.props}
              authed={this.props.user}
              clientState={ClientStateConstants.PENDING_APPROVAL}
              component={ClientsListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_clients"
              ...
              {...this.props}
              authed={this.props.user}
              clientState={ClientStateConstants.EXITED}
              component={ClientsListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_clients"
              ...
              {...this.props}
              authed={this.props.user}
              clientState={ClientStateConstants.BLACKLISTED}
              component={ClientsListDisplay}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/all"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.ALL_LOANS}
              component={LoanListDisplay}
            />

            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/pending"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.PENDING_APPROVAL}
              loanSubState={LoanSubStateConstants.All}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/pending/pending-approval"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.PENDING_APPROVAL}
              loanSubState={LoanSubStateConstants.Pending_1stLevel_Approval}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/pending/pending-management"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.PENDING_APPROVAL}
              loanSubState={LoanSubStateConstants.Pending_2ndLevel_Approval}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/pending/pending-acceptance"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.PENDING_APPROVAL}
              loanSubState={LoanSubStateConstants.Pending_Client_Acceptance}
              component={LoanListDisplay}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/approved"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.APPROVED}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/rejected"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.REJECTED}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/active"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.ACTIVE}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/arrears"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.IN_ARREARS}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/closed"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.CLOSED}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/closed-off"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.CLOSED_WRITTEN_OFF}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/closed-withdrawn"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.CLOSED_WITHDRAWN}
              component={LoanListDisplay}
            />
            <PrivateRoute
              accessRequired="bnk_view_loan_accounts"
              exact
              path="/all-loans/partial-application"
              {...this.props}
              authed={this.props.user}
              loanState={LoanStateConstants.PARTIAL_APPLICATION}
              component={LoanListDisplay}
            />

            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              exact
              path="/deposits/all"
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.ALL}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              exact
              path="/deposits/partial-applications"
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.Partial_Application}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              exact
              path="/deposits/pending-approval"
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.Pending_Approval}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              ...
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.Approved}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              ...
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.ACTIVE}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              exact
              path="/deposits/locked"
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.LOCKED}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              ...
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.CLOSED}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              exact
              path="/deposits/matured"
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.MARTURED}
              component={DepositManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_deposit_accounts"
              exact
              path="/deposits/rejected"
              {...this.props}
              authed={this.props.user}
              depositState={DepositStateConstants.REJECTED}
              component={DepositManagement}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_create_loan"
              exact
              path="/all-loans/newloan-account"
              {...this.props}
              authed={this.props.user}
              component={NewLoanAccount}
            />
            <PrivateRoute
              accessRequired="bnk_create_loan"
              exact
              path="/all-loans/newloan-account/:clientId"
              {...this.props}
              authed={this.props.user}
              component={NewLoanAccount}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_edit_loan_account"
              exact
              path="/all-loans/:clientId/:loanId/edit"
              {...this.props}
              authed={this.props.user}
              component={EditALoanAccount}
            />

            <PrivateRoute
              accessRequired="bnk_refinance_loan_account"
              exact
              path="/all-loans/:clientId/:loanId/refinance"
              {...this.props}
              authed={this.props.user}
              component={RefinanceALoanAccount}
            />
            <PrivateRoute
              accessRequired="bnk_reschedule_loan_account"
              exact
              path="/all-loans/:clientId/:loanId/reschedule"
              {...this.props}
              authed={this.props.user}
              component={RescheduleALoanAccount}
            />

            <PrivateRoute
              accessRequired="bnk_view_clients"
              exact
              path="/all-loans/:clientId"
              {...this.props}
              authed={this.props.user}
              component={LoanClient}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/all-items"
              {...this.props}
              authed={this.props.user}
              component={AllDisbursements}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
            ...
            />
            <PrivateRoute
              accessRequired="bnk_initiate_disbursements"
              exact
              path="/disbursements/initiate"
              {...this.props}
              authed={this.props.user}
              component={InitiateDisbursement}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              ...
              {...this.props}
              authed={this.props.user}
              component={InitiatedDisbursmentBatches}
            />

            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/all/:batchRef"
              {...this.props}
              authed={this.props.user}
              component={ViewADisbursmentBatch}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/partial/:batchRef"
              {...this.props}
              authed={this.props.user}
              component={ViewADisbursmentBatch}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/pending-review/:batchRef"
              {...this.props}
              authed={this.props.user}
              component={ViewADisbursmentBatch}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/pending-approval/:batchRef"
              {...this.props}
              authed={this.props.user}
              component={ViewADisbursmentBatch}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/pending-review"
              {...this.props}
              authed={this.props.user}
              component={DisbursementPendingReview}
            />
            <PrivateRoute
              accessRequired="bnk_view_disbursements"
              exact
              path="/disbursements/pending-approval"
              {...this.props}
              authed={this.props.user}
              component={DisbursementPendingApproval}
            />
            <PrivateRoute
              accessRequired="bnk_view_nip_requests"
              exact
              path="/disbursements/nip-requests"
              {...this.props}
              authed={this.props.user}
              component={NipRequests}
            />
            <PrivateRoute
              accessRequired="bnk_view_nip_requests"
              exact
              path="/disbursements/nip-requests/outwards"
              {...this.props}
              authed={this.props.user}
              component={NipOutwardsRequests}
            />

            <PrivateRoute
              accessRequired="bnk_create_deposit"
              exact
              path="/deposits/newaccount"
              {...this.props}
              authed={this.props.user}
              component={NewDepositAccount}
            />
            <PrivateRoute
              accessRequired="bnk_create_deposit"
              exact
              path="/deposits/newaccount/:clientId"
              {...this.props}
              authed={this.props.user}
              component={NewDepositAccount}
            />
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              component={AllLoanSchedules}
            />
            <PrivateRoute
              accessRequired="bnk_view_all_loan_schedules"
              exact
              path="/reports/loans/loans-par"
              {...this.props}
              authed={this.props.user}
              component={LoanPAR}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_all_loan_transactions"
              exact
              path="/loan-transactions"
              {...this.props}
              authed={this.props.user}
              component={LoanTransactionsManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_all_loan_transactions"
              exact
              path="/loan-transactions/:accountEncodedKey"
              {...this.props}
              authed={this.props.user}
              component={LoanTransactionsManagement}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_all_deposit_transactions"
              exact
              path="/deposit-transactions"
              {...this.props}
              authed={this.props.user}
              component={DepositTransactionsManagement}
            />
            <PrivateRoute
              accessRequired="bnk_view_all_deposit_transactions"
              exact
              path="/deposit-transactions/:accountEncodedKey"
              {...this.props}
              authed={this.props.user}
              component={DepositTransactionsManagement}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_view_activities"
              exact
              path="/activities"
              {...this.props}
              authed={this.props.user}
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_branches"
              exact
              path="/branches"
              {...this.props}
              authed={this.props.user}
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_all_users"
              exact
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_all_communications"
              exact
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_email_communications"
              exact
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_sms_communications"
              exact
              path="/communications/sms"
              {...this.props}
              authed={this.props.user}
              component={SMSCommunications}
            />
            <PrivateRoute
              accessRequired="bnk_view_web_hooks"
              exact
              path="/communications/webhooks"
              {...this.props}
              authed={this.props.user}
              component={WebhooksCommunications}
            />

            <PrivateRoute
              accessRequired="bnk_view_charts_of_accounts"
              exact
              path="/accounts"
              {...this.props}
              authed={this.props.user}
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_journal_entries"
              exact
              path="/journals"
              {...this.props}
              authed={this.props.user}
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_trial_balance"
              exact
              path="/trial-balance-basic"
              {...this.props}
              authed={this.props.user}
              component={TrialBalanceBasic}
            />
            <PrivateRoute
              accessRequired="bnk_view_trial_balance"
              exact
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_profit_and_loss"
              exact
              path="/profit-loss"
              {...this.props}
              authed={this.props.user}
            ...
            />
            <PrivateRoute
              accessRequired="bnk_view_balance_sheet"
              exact
              path="/balancesheet"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              ...
              exact
              path="/platform/customer-whitelist"
              {...this.props}
              authed={this.props.user}
              component={ManageCustomerWhitelist}
            />
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/platform/company-info"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              component={GeneralOrganization}
            />
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/general/risk-levels"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/general/notifications"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/general/transaction"
              {...this.props}
              authed={this.props.user}
              component={TransactionServices}
            />

            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/general/currency"
              {...this.props}
              authed={this.props.user}
              component={GeneralCurrency}
            />
            <PrivateRoute
              accessRequired="bnk_manage_transaction_channels"
              exact
              path="/administration/general/txt-channels"
              {...this.props}
              authed={this.props.user}
              component={GeneralTxtChannels}
            />
            <PrivateRoute
              accessRequired="bnk_manage_transaction_channels"
              exact
              path="/administration/general/new-txt-channels"
              {...this.props}
              authed={this.props.user}
              component={NewTxtChannels}
            />
            <PrivateRoute
            ...
            />
            <PrivateRoute
              accessRequired="bnk_manage_internal_control"
              exact
              path="/administration/general/control"
              {...this.props}
              authed={this.props.user}
              component={GeneralInternalControl}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/uploaddata"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              component={BranchListManagement}
            />
...
=======
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/organization/newbranch"
              {...this.props}
              authed={this.props.user}
              component={NewBranch}
            />
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/organization/editbranch/:encodedkey"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/branch-closures"
              {...this.props}
              authed={this.props.user}
              component={OrganizationBranchesClosures}
            />
            {/* <PrivateRoute accessRequired="bnk_manage_organisation" exact path='/administration/organization/branch-closures' {...this.props} authed={this.props.user} component={OrganizationBranchesClosures} /> */}
            {/* <PrivateRoute accessRequired="bnk_manage_organisation" exact path='/administration/organization/branch-closures/open' {...this.props} authed={this.props.user} component={OrganizationBranchesOpen} />
>>>>>>> 03e1de781b186a574a10b9d6117f43ea6dda3fea
            ...
            <PrivateRoute
              accessRequired="bnk_manage_sms_provider"
              exact
            ...
            />
            <PrivateRoute
              accessRequired="bnk_manage_email_provider"
              exact
            ...
            <PrivateRoute
              accessRequired="bnk_manage_products"
              exact
            ...
            <PrivateRoute
              accessRequired="bnk_manage_products"
              exact
              path="/administration/products/deposits"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              accessRequired="bnk_manage_products"
              exact
              path="/administration/products/deposit/edit/:encodedKey"
              {...this.props}
              authed={this.props.user}
              component={EditADepositsProduct}
            />
            <PrivateRoute
              accessRequired="bnk_manage_products"
              exact
              path="/administration/products/newdeposits-product"
              {...this.props}
              authed={this.props.user}
              component={NewDepositsProduct}
            />
            <PrivateRoute
              accessRequired="bnk_manage_products"
              exact
              path="/administration/products/newloan-product"
              {...this.props}
              authed={this.props.user}
              component={NewLoanProduct}
            />
            <PrivateRoute
              accessRequired="bnk_manage_products"
              exact
              path="/administration/products/loans/edit/:encodedKey"
              {...this.props}
              authed={this.props.user}
              component={EditLoanProduct}
            />

            <PrivateRoute
              accessRequired="bnk_manage_role"
              exact
            ...
            <PrivateRoute
              accessRequired="bnk_manage_role"
              exact
              path="/administration/access/new-role"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              accessRequired="bnk_manage_role"
              exact
              path="/administration/access/edit-role/:roleId"
              {...this.props}
              authed={this.props.user}
              component={EditRole}
            />
            ...
            <PrivateRoute
              accessRequired="bnk_manage_users"
              exact
            ...
            <PrivateRoute
              accessRequired="bnk_manage_users"
              exact
              path="/administration/access/new-user"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              accessRequired="bnk_manage_users"
              exact
              path="/administration/access/edit-user/:encodedKey"
              {...this.props}
              authed={this.props.user}
              component={EditUser}
            />
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              component={PlatformCardProvider}
            />
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/platform/payroll-group"
              {...this.props}
              authed={this.props.user}
              component={PlatformPayrollGroup}
            />

            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/access/preferences"
              {...this.props}
              authed={this.props.user}
              component={AccessPreferences}
            />
            <PrivateRoute
              accessRequired="bnk_manage_organisation"
              exact
              path="/administration/access/authentication"
              {...this.props}
              authed={this.props.user}
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              component={CustomerAccountContainer}
            />
            <PrivateRoute
              accessRequired="bnk_view_clients"
              path="/group/:id"
            ...
            <PrivateRoute
              ...
              {...this.props}
              authed={this.props.user}
              component={DepositProductInfoContainer}
            />
            <PrivateRoute
              accessRequired="bnk_manage_products"
              ...
              {...this.props}
              authed={this.props.user}
              component={DepositProductChargesContainer}
            />
            <PrivateRoute
              accessRequired="bnk_manage_products"
              ...
              {...this.props}
              authed={this.props.user}
              component={LoanProductInfoContainer}
            />
            <PrivateRoute
              accessRequired="bnk_manage_products"
              ...
              {...this.props}
              authed={this.props.user}
              component={LoanProductChargesContainer}
            />
            <PrivateRoute
              exact
