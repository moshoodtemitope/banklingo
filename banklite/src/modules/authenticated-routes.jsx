        ...
        return (
                ...
                <Fragment>
                    ...
                    <Switch>
                        ...
                        <PrivateRoute accessRequired="bnk_view_clients" exact path='/disbursements/all/:batchRef' {...this.props} authed={this.props.user} component={ViewADisbursmentBatch} /> 
                        ...
                        <PrivateRoute accessRequired="bnk_view_clients" exact path='/disbursements/pending-review/:batchRef' {...this.props} authed={this.props.user} component={ViewADisbursmentBatch} /> 
                        <PrivateRoute accessRequired="bnk_view_clients" exact path='/disbursements/pending-approval/:batchRef' {...this.props} authed={this.props.user} component={ViewADisbursmentBatch} /> 
