        ...
        if (
          ...
          if (getAllUsersRequest.request_data.response.data.length >= 1) {
            if (
              ...
              if (
                loanData.loanState === 3 ||
                loanData.loanState === 5 ||
                loanData.loanState === 6
              ) {
                loanAccountValidationSchema = Yup.object().shape({
                  productDisplayName: Yup.string()
                    .min(1, 'Valid response required')
              ...
              return (
                <Formik
                  ...
                  onSubmit={(values, { resetForm }) => {
                    ...
                    this.editLoanAccount(
                      loanAccountPayload,
                      loanData.loanState
                    ).then(() => {
                      if (
                        this.props.editALoanReducer.request_status ===
                        loanAndDepositsConstants.EDIT_A_LOAN_SUCCESS
                      ) {
                        setTimeout(() => {
                          // resetForm();
                          // this.props.dispatch(loanActions.editALoan("CLEAR"))
                      ...
                      if (
                        this.props.editALoanReducer.request_status ===
                        loanAndDepositsConstants.EDIT_A_LOAN_FAILURE
                      ) {
                        setTimeout(() => {
                          // resetForm();
                          // this.props.dispatch(loanActions.editALoan("CLEAR"))
                  ...
                  {({
                    ...
                    >
                              ...
                              <Form.Row>
                                <Col className='date-wrap'>
                                  ...
                                  <DatePicker
                                    ...
                                    showYearDropdown
                                    value={
                                      this.state.anticipatedDisbursmentDate
                                    }
                      ...
                      <div className='footer-with-cta toleft'>
                        ...
                        >
                          {editALoanRequest.is_request_processing
                            ? 'Please wait...'
                            : 'Update Loan Account'}
                        </Button>
                      </div>
                      {editALoanRequest.request_status ===
                        loanAndDepositsConstants.EDIT_A_LOAN_FAILURE && (
                        <Alert className='mt-20' variant='danger'>
                          {editALoanRequest.request_data.error}{' '}
                        </Alert>
                      )}
                      ...
                      {editALoanRequest.request_status ===
                        ...
                        <Alert className='mt-20' variant='success'>
                          {editALoanRequest.request_data.response.data.message}{' '}
                        </Alert>
                      )}
                    </Form>
                  )}
