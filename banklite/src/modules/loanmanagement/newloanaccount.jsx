                                                ...
                                                onSubmit={(values, { resetForm }) => {
                                                    ...
                                                    .then(
                                                        () => {
                                                            ...
                                                            if (this.props.createLoanAccountReducer.request_status === loanAndDepositsConstants.CREATE_A_LOAN_ACCOUNT_FAILURE) {
                                                                setTimeout(() => {
                                                                    // resetForm();
                                                                    this.props.dispatch(loanActions.createLoanAccount("CLEAR"))
                                                                }, 8000);
                                                            ...
                                                            <div className="footer-with-cta toleft">
                                                                ...
                                                                <Button
                                                                    ...
                                                                    disabled={createLoanAccountRequest.is_request_processing}>
                                                                        {createLoanAccountRequest.is_request_processing?"Please wait...": "Create Loan Account"}
                                                                </Button>
                                                            </div>
                                                            {createLoanAccountRequest.request_status === loanAndDepositsConstants.CREATE_A_LOAN_ACCOUNT_FAILURE && 
                                                                <Alert className="mt-20" variant="danger">{createLoanAccountRequest.request_data.error} </Alert>
                                                            }

                                                            {createLoanAccountRequest.request_status === loanAndDepositsConstants.CREATE_A_LOAN_ACCOUNT_SUCCESS && 
                                                                <Alert className="mt-20" variant="success">{createLoanAccountRequest.request_data.response.data.message} </Alert>
                                                            }
                                                        </Form>
                                                    )}
                                            </Formik>
