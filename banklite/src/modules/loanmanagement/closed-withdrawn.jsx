...
class ClosedWithDrawnLoans extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      user: '',
  ...
  getLoans = (paramters) => {
    ...
    dispatch(loanActions.getClosedWithdrawnLoans(paramters));
  };
  ...
  setPagesize = (PageSize, tempData) => {
    ...
    if (tempData) {
      dispatch(loanActions.getClosedWithdrawnLoans(params, tempData));
    } else {
      dispatch(loanActions.getClosedWithdrawnLoans(params));
    }
  };
...
function mapStateToProps(state) {
  return {
    getLoansRequest: state.loansReducers.getClosedWithdrawnLoansReducer,
  };
}

export default connect(mapStateToProps)(ClosedWithDrawnLoans);
