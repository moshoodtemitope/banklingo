...
class ApprovedLoans extends React.Component {
  ...
  getLoans = (paramters) => {
    ...
    dispatch(loanActions.getApprovedLoans(paramters));
  };
  ...
  exportLoansAccounts = () => {
    ...
    let params = `PageSize=${PageSize}&CurrentPage=${CurrentPage}&StartDate=${startDate}&endDate=${endDate}&SearchText=${SearchText}&LoanState=3`;
...
export default connect(mapStateToProps)(ApprovedLoans);
