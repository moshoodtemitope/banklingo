...
import { numberWithCommas, allowNumbersOnly, noWhiteSpaces, getDateFromISO} from '../../shared/utils';
...
class RescheduleALoanAccount extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleDisbursemntDatePicker = (anticipatedDisbursmentDate) => {
        anticipatedDisbursmentDate.setHours(anticipatedDisbursmentDate.getHours() + 1);
        
        
        this.setState({ anticipatedDisbursmentDate: getDateFromISO(anticipatedDisbursmentDate.toISOString()) });
    }
    ...
    handleRepayDatePicker = (firstRepaymentDate) => {
        ...
        this.setState({ firstRepaymentDate: getDateFromISO(firstRepaymentDate.toISOString()) });
    }
    ...
    getSchedulePreview = ()=>{
        ...
        this.loanSchedulePayload.interestRateTerms = (this.selectedLoanProductDetails.loanProductInterestSetting!==null && this.selectedLoanProductDetails.loanProductInterestSetting.interestRateTerms!==null) ? this.selectedLoanProductDetails.loanProductInterestSetting.interestRateTerms: '';
        this.loanSchedulePayload.interestBalanceCalculation = (this.selectedLoanProductDetails.repaymentReschedulingModel!==null && this.selectedLoanProductDetails.repaymentReschedulingModel.interestBalanceCalculation!==null) ? this.selectedLoanProductDetails.repaymentReschedulingModel.interestBalanceCalculation: 1;
        ...
        if(!this.loanSchedulePayload.reschdeuleInfo){
            this.loanSchedulePayloadError.errorMessage =  "Outstanding Balances and topup amount required";
        ...
        if(this.loanSchedulePayload.reschdeuleInfo.interestBalance===""){
            
            this.loanSchedulePayloadError.errorMessage =  "Outstanding interest balance required";
            this.loanSchedulePayloadError.isError =  true;
        ...
        if(this.loanSchedulePayload.reschdeuleInfo.outstandingFees===""){
        ...
        if(this.loanSchedulePayload.reschdeuleInfo.outstandingPenalty===""){
            
            this.loanSchedulePayloadError.errorMessage =  "Outstanding Penalty required";
            this.loanSchedulePayloadError.isError =  true;
        ...
        if(this.loanSchedulePayload.reschdeuleInfo.outstandingPrincipal===""){
            
            this.loanSchedulePayloadError.errorMessage =  "Outstanding Principal required";
            this.loanSchedulePayloadError.isError =  true;
        ...
        if(this.loanSchedulePayload.loanAmount==='' || this.loanSchedulePayload.loanAmount < 1){
        ...
        if( this.loanSchedulePayload.installments==='' && this.loanSchedulePayload.installments < 1){
            this.loanSchedulePayloadError.errorMessage =  "Number of Installments is required";
            this.loanSchedulePayloadError.isError =  true;
        ...
        if( this.loanSchedulePayload.interestRateTerms===''){
            this.loanSchedulePayloadError.errorMessage =  "Interest rate terms is required";
            this.loanSchedulePayloadError.isError =  true;
        ...
        if( this.loanSchedulePayload.InterestBalanceCalculation===''){
            this.loanSchedulePayloadError.errorMessage =  "Interest balance calculation is required";
            this.loanSchedulePayloadError.isError =  true;
        ...
        let getScheduleData = {
                ...
                interestBalanceCalculation: this.loanSchedulePayload.interestBalanceCalculation,
    ...
    rescheduleLoanAccount = async(accouuntPayload, accountType)=>{
        const {dispatch} = this.props;
        this.props.dispatch(loanActions.rescheduleALoan("CLEAR"))
        await dispatch(loanActions.rescheduleALoan(accouuntPayload));
    ...
    renderRescheduleLoanAccount = ()=>{
        let getAllLoanProductsRequest = this.props.getAllLoanProductsReducer,
            rescheduleALoanRequest = this.props.rescheduleALoanReducer,
            ...
            if(getAllLoanProductsRequest.request_status===productsConstants.GET_ALL_LOAN_PRODUCTS_PENDING 
                ...
                ||adminGetTransactionChannelsRequest.request_status=== administrationConstants.GET_TRANSACTION_CHANNELS_PENDING
                ||adminGetAllBranchesRequest.request_status=== administrationConstants.GET_ALL_BRANCHES_PENDING
                || getAllUsersRequest.request_status ===administrationConstants.GET_ALL_USERS_PENDING
            ...
            if(getAllLoanProductsRequest.request_status === productsConstants.GET_ALL_LOAN_PRODUCTS_SUCCESS 
                && 
                    (  
                        ( 
                            ...
                            &&
                                getAClientLoanAccountRequest.request_status === loanAndDepositsConstants.GET_A_LOAN_ACCOUNT_DETAILS_SUCCESS
                            &&  getAClientRequest.request_status!==clientsConstants.GET_A_CLIENT_PENDING
                        )
                ...
                && getAllUsersRequest.request_status === administrationConstants.GET_ALL_USERS_SUCCESS
                            ...
                            if(getAllUsersRequest.request_data.response.data.length>=1){
                                if(adminGetTransactionChannelsRequest.request_data.response.data.result.length>=1){
                                        ...
                                        let allLoanProducts             = getAllLoanProductsRequest.request_data.response.data.result,
                                            loanData                = getAClientLoanAccountRequest.request_data.response.data,
                                            allAccountOfficers          = getAllUsersRequest.request_data.response.data,
                                            allChannels                 = adminGetTransactionChannelsRequest.request_data.response.data.result,
                                            allBranches                 = adminGetAllBranchesRequest.request_data.response.data.result,
                                            allCustomersList            =[],
                                            allBranchesList             =[],
                                            allLoanProductsList         =[],
                                        ...
                                        let {user}                      = this.state,
                                            ...
                                            allLoanProducts = allLoanProducts.filter(product=>product.loanProductType===0);
                                            ...
                                            allowedBranches.map((branch, id)=>{
                                                allowedBranchesList.push({label: branch.name, value:branch.encodedKey});
                                            })

                                            allLoanProducts.map((product, id)=>{
                                                allLoanProductsList.push({label: product.productName, value:product.productEncodedKey});
                                            })

                                            

                                            allBranches.map((branch, id)=>{
                                                allBranchesList.push({label: branch.name, value:branch.encodedKey});
                                            })

                                            allAccountOfficers.map((officer, id)=>{
                                                allAccountOfficersList.push({label: officer.name, value:officer.key});
                                            })

                                            allChannels.map((channel, id)=>{
                                                allChannelsList.push({label: channel.name, value:channel.encodedKey});
                                            })
                                        let allProductTypes = [
                                        ...
                                        let loanAccountValidationSchema = Yup.object().shape({
                                            ...
                                            interestBalance:  Yup.string()
                                                    .required("Reqiured"),
                                            outstandingFees:  Yup.string()
                                                .required('Required'),
                                            outstandingPenalty:  Yup.string()
                                                .required('Required'),
                                            outstandingPrincipal:  Yup.string()
                                                .required('Required'),
                                        ...
                                        return (
                                            <Formik
                                                initialValues={{
                                                    ...
                                                    productEncodedKey : this.selectedLoanProductDetails.encodedKey,
                                                ...
                                                onSubmit={(values, { resetForm }) => {
                                                    if (this.state.isSubmitable) {
                                                        ...
                                                        loanAccountPayload = {
                                                            ...
                                                            interestRate: parseFloat(values.interestRate.replace(/,/g, '')),
                                                            installments: parseInt(values.installmentsDefault),
                                                            firstRepaymentDate: values.firstRepaymentDate !== "" ? this.loanSchedulePayload.firstRepaymentDate : null,
                                                            accountComment: {
                                                                comments: [
                                                                    ""
                                                                ]
                                                            ...
                                                            rescheduleDetails: {
                                                                reduceBalance: values.allowReduce,
                                                                reducedPrincipal:parseFloat(values.outstandingPrincipal.replace(/,/g, '')),
                                                                interestBalance: parseFloat(values.interestBalance.replace(/,/g, '')),
                                                                feeBalance: parseFloat(values.outstandingFees.replace(/,/g, '')),
                                                                penaltyBalance: parseFloat(values.outstandingPenalty.replace(/,/g, '')),
                                                            }
                                                        }
                                                        ...
                                                        this.rescheduleLoanAccount(loanAccountPayload)
                                                            .then(
                                                                () => {

                                                                    if (this.props.rescheduleALoanReducer.request_status === loanAndDepositsConstants.RESCHEDULE_LOAN_SUCCESS) {
                                                                        setTimeout(() => {
                                                                            // resetForm();
                                                                            // this.props.dispatch(loanActions.rescheduleALoan("CLEAR"))
                                                                        }, 3000);
                                                                    ...
                                                                    // if (this.props.rescheduleALoanReducer.request_status === loanAndDepositsConstants.RESCHEDULE_LOAN_FAILURE) {
                                                                    //     setTimeout(() => {
                                                                    //         // resetForm();
                                                                    //         this.props.dispatch(loanActions.rescheduleALoan("CLEAR"))
                                                                    //     }, 8000);
                                                ...
                                                {({ handleSubmit,
                                                    ...
                                                    errors, }) => (
                                                        <Form
                                                            ...
                                                            <h3>Rescheduling Loan Account ({loanData.accountNumber})</h3>
                                                            </div>
                                                            <Form.Row>
                                                                ...
                                                                <Col>
                                                                    ...
                                                                    <Select
                                                                        ...
                                                                        onChange={(selected) => {
                                                                            ...
                                                                            setFieldValue('productDisplayName', selected.label)
                                                        ...
                                                        <Accordion defaultActiveKey="0">
                                                            ...
                                                            <Accordion.Collapse eventKey="0">
                                                                <div className="each-formsection">
                                                                    <Form.Row>
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    delete this.loanSchedulePayload.reschdeuleInfo.interestBalance;
                                                                                    this.loanSchedulePayload.reschdeuleInfo.interestBalance = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    setFieldValue("interestBalance", numberWithCommas(e.target.value));
                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false, interestBalance: parseFloat(e.target.value.replace(/,/g, ''))})
                                                                                        if(parseFloat(e.target.value.replace(/,/g, '')) < loanData.outstandingInterest){
                                                                                            this.setState({ interestMinError: true, isSubmitable:false })
                                                                                        }else{
                                                                                            this.setState({ interestMinError: false, isSubmitable:true })
                                                                                        }
                                                                                    }else{
                                                                                ...
                                                                                value={numberWithCommas(values.interestBalance)}
                                                                                className={((errors.interestBalance && touched.interestBalance)|| this.state.interestMinError) ? "is-invalid" : null}
                                                                                name="interestBalance" required
                                                                            />
                                                                            <span className="input-helptext form-text">
                                                                                ...
                                                                                {loanData.outstandingInterest !== null &&
                                                                                    <span>  Min: &#8358;{numberWithCommas(loanData.outstandingInterest, true)}</span>
                                                                                }

                                                                               

                                                                            </span>
                                                                            {errors.interestBalance && touched.interestBalance ? (
                                                                                <span className="invalid-feedback">{errors.interestBalance}</span>
                                                                            ) : null}

                                                                            {this.state.interestMinError && 
                                                                                <span className="invalid-feedback">Below minimum</span>
                                                                            }
                                                                        </Col>
                                                                        <Col>
                                                                            <Form.Label className="block-level">Fee Balance &#8358;</Form.Label>
                                                                            <Form.Control
                                                                                type="text"
                                                                                autoComplete="off"
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.reschdeuleInfo.outstandingFees = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    setFieldValue("outstandingFees", numberWithCommas(e.target.value))
                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false, outstandingFees:parseFloat(e.target.value.replace(/,/g, ''))})
                                                                                    }
                                                                                    else{
                                                                                    ...
                                                                                    if(parseFloat(e.target.value.replace(/,/g, '')) < loanData.outstandingFees){
                                                                                        this.setState({ feeMinError: true, isSubmitable:false })
                                                                                    }else{
                                                                                        this.setState({ feeMinError: false, isSubmitable:true })
                                                                                    }
                                                                                }}
                                                                                value={numberWithCommas(values.outstandingFees)}
                                                                                className={((errors.outstandingFees && touched.outstandingFees)||this.state.feeMinError) ? "is-invalid h-38px" : "h-38px"}
                                                                                name="outstandingFees" required />
                                                                            ...
                                                                            <span className="input-helptext form-text">
                                                                                ...
                                                                                {loanData.outstandingFees !== null &&
                                                                                    <span>  Min: &#8358;{numberWithCommas(loanData.outstandingFees, true)}</span>
                                                                                }

                                                                               

                                                                            </span>
                                                                            {errors.outstandingFees && touched.outstandingFees ? (
                                                                                <span className="invalid-feedback">{errors.outstandingFees}</span>
                                                                            ) : null}
                                                                    ...
                                                                    <Form.Row>
                                                                        <Col sm={6}>
                                                                            <Form.Label className="block-level">Penalty Balance (&#8358;) </Form.Label>
                                                                            <Form.Control
                                                                                type="text"
                                                                                autoComplete="off"
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.reschdeuleInfo.outstandingPenalty = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    setFieldValue("outstandingPenalty", numberWithCommas(e.target.value))
                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false, outstandingPenalty:parseFloat(e.target.value.replace(/,/g, '')) })
                                                                                    }
                                                                                    else{
                                                                                        this.setState({outstandingPenalty: null})
                                                                                    }
                                                                                    
                                                                                    if(parseFloat(e.target.value.replace(/,/g, '')) < loanData.outstandingPenalty){
                                                                                        this.setState({ penaltyMinError: true, isSubmitable:false })
                                                                                    }else{
                                                                                        this.setState({ penaltyMinError: false, isSubmitable:true })
                                                                                    }
                                                                                }}
                                                                                value={numberWithCommas(values.outstandingPenalty)}
                                                                                className={((errors.outstandingPenalty && touched.outstandingPenalty)|| this.state.penaltyMinError) ? "is-invalid" : null}
                                                                            ...
                                                                            <span className="input-helptext form-text">
                                                                                ...
                                                                                {loanData.outstandingPenalty !== null &&
                                                                                    <span>  Min: &#8358;{numberWithCommas(loanData.outstandingPenalty, true)}</span>
                                                                                }

                                                                               

                                                                            </span>
                                                                            {errors.outstandingPenalty && touched.outstandingPenalty ? (
                                                                                <span className="invalid-feedback">{errors.outstandingPenalty}</span>
                                                                            ) : null}
                                                        ...
                                                        <Accordion defaultActiveKey="0">
                                                            ...
                                                            <Accordion.Collapse eventKey="0">
                                                                ...
                                                                <Form.Row>
                                                                        <Col>
                                                                            <Form.Label className="block-level">Current Oustanding Principal (&#8358;)</Form.Label>
                                                                            <Form.Control
                                                                                type="text"
                                                                                autoComplete="off"
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.reschdeuleInfo.outstandingPrincipal = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    setFieldValue("outstandingPrincipal", numberWithCommas(e.target.value))
                                                                                    if (e.target.value !== '') {

                                                                                        this.setState({ isscheduleError: false, outstandingPrincipal: parseFloat(e.target.value.replace(/,/g, '')) })
                                                                                    } else {
                                                                                        this.setState({ outstandingPrincipal: null })
                                                                                    }

                                                                                    if ((parseFloat(e.target.value.replace(/,/g, '')) < loanData.outstandingPrincipal) && values.allowReduce===false) {
                                                                                        this.setState({ principalMinError: true, isSubmitable: false })
                                                                                    } else {
                                                                                        this.setState({ principalMinError: false, isSubmitable: true })
                                                                                    }
                                                                                }}
                                                                                value={numberWithCommas(values.outstandingPrincipal)}
                                                                                className={((errors.outstandingPrincipal && touched.outstandingPrincipal) || this.state.principalMinError) ? "is-invalid h-38px" : "h-38px"}
                                                                                name="interestRate" required />

                                                                            <Form.Group className="table-helper mb-0">
                                                                                <input type="checkbox"
                                                                                    name="allowReduce"
                                                                                    // onChange={handleChange}
                                                                                    ...
                                                                                    onChange={(event)=>{
                                                                                        ...
                                                                                        setFieldValue("allowReduce", event.target.checked)
                                                                                        ...
                                                                                        if(event.target.checked === true){
                                                                                            ...
                                                                                            if ((parseFloat(values.outstandingPrincipal.replace(/,/g, '')) < loanData.outstandingPrincipal)) {
                                                                                                this.setState({ principalMinError: true, isSubmitable: false })
                                                                                            }
                                                                                        }
                                                                                    }}
                                                                                    checked={values.allowReduce}
                                                                                    value={values.allowReduce}
                                                                                    id="allowReduce" />
                                                                                <label htmlFor="allowReduce">Reduce Amount</label>
                                                                                
                                                                            </Form.Group>
                                                                            {this.state.principalMinError &&
                                                                                <span className="invalid-feedback">Below minimum</span>
                                                                            }
                                                                            {values.allowReduce===false &&
                                                                                <span className="input-helptext form-text">
                                                                                    {/* {this.selectedLoanProductDetails.loanAmountSetting.loanAmountMinimun !== null &&
                                                                                        <span>Min: &#8358;{numberWithCommas(this.selectedLoanProductDetails.loanAmountSetting.loanAmountMinimun)}</span>
                                                                                    } */}
                                                                                    {loanData.outstandingPrincipal !== null &&
                                                                                        <span>  Min: &#8358;{numberWithCommas(loanData.outstandingPrincipal, true)}</span>
                                                                                    }
                                                                            ...
                                                                            {errors.outstandingPrincipal && touched.outstandingPrincipal ? (
                                                                                <span className="invalid-feedback">{errors.outstandingPrincipal}</span>
                                                                            ) : null}
                                                                    ...
                                                                    <Form.Row>
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.loanAmount = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false })
                                                                                    }
                                                                                    setFieldValue("loanAmount", numberWithCommas(e.target.value));
                                                                                    // setFieldValue("loanAmount", parseFloat(numberWithCommas(e.target.value)));
                                                                                    // if((this.selectedLoanProductDetails.loanAmountSetting.loanAmountMaximum!==null && this.selectedLoanProductDetails.loanAmountSetting.loanAmountMaximum!=="" 
                                                                                    //     && parseFloat(e.target.value) > this.selectedLoanProductDetails.loanAmountSetting.loanAmountMaximum)
                                                                                    //     || 
                                                                        ...
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.interestRate = parseFloat(e.target.value.replace(/,/g, ''));

                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false })
                                                                                    }
                                                                                    setFieldValue("interestRate", numberWithCommas(e.target.value))
                                                                                }}
                                                                    ...
                                                                    <Form.Row>
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                autoComplete="off"
                                                                                onChange={(e) => {
                                                                                    setFieldValue("repayedEvery", numberWithCommas(e.target.value))
                                                                                }}
                                                                                value={values.repayedEvery}
                                                                                className={errors.repayedEvery && touched.repayedEvery ? "is-invalid" : null}
                                                                                name="repayedEvery"
                                                                                required
                                                                                disabled
                                                                            />
                                                                        ...
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    ...
                                                                                    this.loanSchedulePayload.installments = parseInt(e.target.value.replace(/,/g, ''));

                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false })
                                                                                    }
                                                                                    setFieldValue("installmentsDefault", numberWithCommas(e.target.value))
                                                                                }}
                                                                    ...
                                                                    <Form.Row>
                                                                        <Col sm={6}>
                                                                            ...
                                                                            <span className="input-helptext form-text">
                                                                                ...
                                                                                {(values.arearsTolerancePeriodInDaysMin !== null && values.arearsTolerancePeriodInDaysMin !== '') &&
                                                                                    <span>Min: {numberWithCommas(values.arearsTolerancePeriodInDaysMin)}</span>
                                                                                }
                                                                                {(values.arearsTolerancePeriodInDaysMax !== null && values.arearsTolerancePeriodInDaysMax !== '') &&
                                                                                    <span>  Max: {numberWithCommas(values.arearsTolerancePeriodInDaysMax)}</span>
                                                                                }
                                                                        ...
                                                                        <Col sm={6}>
                                                                            ...
                                                                            <span className="form-text">
                                                                                {(values.interestCalcMethodText !== null && values.interestCalcMethodText !== '') &&
                                                                                    <span>{values.interestCalcMethodText}</span>
                                                                                }
                                                                        ...
                                                                        <Form.Row>
                                                                            <Col className="date-wrap">
                                                                                ...
                                                                                <DatePicker  
                                                                                    ...
                                                                                    selected={null}
                                                                                    onChange={(e)=> {this.handleDisbursemntDatePicker(e); setFieldValue('anticipatedDisbursmentDate', e) }}
                                                                                    showYearDropdown
                                                                                    ...
                                                                                    dropdownMode="select"
                                                                                    minDate={new Date()}
                                                                                    className={errors.anticipatedDisbursmentDate && touched.anticipatedDisbursmentDate ? "is-invalid form-control form-control-sm" : "form-control form-control-sm"}
                                                                                />
                                                                                {errors.anticipatedDisbursmentDate && touched.anticipatedDisbursmentDate ? (
                                                                                    <span className="invalid-feedback">{errors.anticipatedDisbursmentDate}</span>
                                                                                ) : null}
                                                                            </Col>
                                                                            <Col className="date-wrap">
                                                                                ...
                                                                                <DatePicker                                                                     
                                                                                    ...
                                                                                    onChange={(firstRepaymentDate)=>{
                                                                                        ...
                                                                                        if(firstRepaymentDate!==''){
                                                                                            this.loanSchedulePayload.firstRepaymentDate = this.refineDateIso(getDateFromISO(firstRepaymentDate.toISOString()));
                                                                                            this.setState({isscheduleError: false, })
                                                                                        }
                                                                                        setFieldValue("firstRepaymentDate",getDateFromISO(firstRepaymentDate.toISOString()))
                                                                                    ...
                                                                                    dropdownMode="select"
                                                                                    minDate={new Date()}
                                                                                    className={errors.firstRepaymentDate && touched.firstRepaymentDate ? "is-invalid form-control form-control-sm" : "form-control form-control-sm"}
                                                                                />
                                                            ...
                                                            <Accordion >
                                                                ...
                                                                <Accordion.Collapse eventKey="0">
                                                                    <div className="each-formsection">
                                                                        ...
                                                                        {getLoanSchedulePreviewRequest.request_status === loanAndDepositsConstants.PREVIEW_LOAN_SCHEDULE_SUCCESS && 
                                                                            this.renderSchedulePreview(getLoanSchedulePreviewRequest.request_data.response.data.result)
                                                                        }
                                                                        ...
                                                                        <Button 
                                                                            ...
                                                                            disabled={getLoanSchedulePreviewRequest.is_request_processing}
                                                                            onClick={()=>{
                                                                                if(values.interestRate!==''){
                                                                                    this.loanSchedulePayload.interestRate = parseFloat(values.interestRate.toString().replace(/,/g, ''));
                                                                                }
                                                                                ...
                                                                                if(values.installmentsDefault!==''){
                                                                                    this.loanSchedulePayload.installments = parseInt(values.installmentsDefault.toString().replace(/,/g, ''));
                                                                                }else{
                                                                                    this.loanSchedulePayload.installments = (this.selectedLoanProductDetails.repaymentReschedulingModel!==null && this.selectedLoanProductDetails.repaymentReschedulingModel.installmentsDefault!==null) ? parseInt(this.selectedLoanProductDetails.repaymentReschedulingModel.installmentsDefault): '';
                                                                                }

                                                                                this.loanSchedulePayload.reschdeuleInfo.interestBalance=values.interestBalance;
                                                                                this.loanSchedulePayload.reschdeuleInfo.outstandingFees=values.outstandingFees;
                                                                                this.loanSchedulePayload.reschdeuleInfo.outstandingPenalty=values.outstandingPenalty;
                                                                                this.loanSchedulePayload.reschdeuleInfo.outstandingPrincipal=values.outstandingPrincipal;

                                                                                
                                                                                this.loanSchedulePayload.loanAmount = parseFloat(values.interestBalance.toString().replace(/,/g, ''))+
                                                                                                                        parseFloat(values.outstandingFees.toString().replace(/,/g, ''))+
                                                                                                                        parseFloat(values.outstandingPrincipal.toString().replace(/,/g, ''))+
                                                                                                                        parseFloat(values.outstandingPenalty.toString().replace(/,/g, ''))
                                                                                
                                                                                this.getSchedulePreview()
                                                                            }}
                                                                        >{getLoanSchedulePreviewRequest.is_request_processing?"Please wait...":"Preview Schedule"}
                                                                            </Button>
                                                                        {(this.state.isscheduleError===true 
                                                                            && this.state.scheduleErrorMsg!=='') && 
                                                                            <Alert className="mt-20" variant="danger">{this.state.scheduleErrorMsg} </Alert>
                                                                        }

                                                                        {getLoanSchedulePreviewRequest.request_status === loanAndDepositsConstants.PREVIEW_LOAN_SCHEDULE_FAILURE && 
                                                                            <Alert className="mt-20" variant="danger">{getLoanSchedulePreviewRequest.request_data.error} </Alert>
                                                                        }
                                                                        ...
                                                                        <Form.Row>
                                                                            <Col>
                                                                                ...
                                                                                <Select
                                                                                    ...
                                                                                    onChange={(selected) => {
                                                                                        setFieldValue('accountOfficerEncodedKey', selected.value)
                                                                                    }}
                                                                                    onBlur={()=> setFieldTouched('accountOfficerEncodedKey', true)}
                                                                                    // onChange={(selectedLoanProduct) => {
                                                                                    //     this.setState({ selectedLoanProduct });
                                                                                    //     errors.productEncodedKey = null
                                                                                    //     values.productEncodedKey = selectedLoanProduct.value
                                                                            ...
                                                                            <Col>
                                                                                ...
                                                                                <Select
                                                                                    ...
                                                                                    onChange={(selected) => {
                                                                                        setFieldValue('accountOfficerBranchEncodedKey', selected.value)
                                                                                    }}
                                                                                    onBlur={()=> setFieldTouched('accountOfficerBranchEncodedKey', true)}
                                                                                    // onChange={(selectedLoanProduct) => {
                                                                                    //     this.setState({ selectedLoanProduct });
                                                                                    //     errors.productEncodedKey = null
                                                                                    //     values.productEncodedKey = selectedLoanProduct.value
                                                                                    // }}
                                                                                    className={errors.accountOfficerBranchEncodedKey && touched.accountOfficerBranchEncodedKey ? "is-invalid" : null}
                                                                                    ...
                                                                                    required
                                                                                />
                                                                                {errors.accountOfficerBranchEncodedKey && touched.accountOfficerBranchEncodedKey ? (
                                                                                    <span className="invalid-feedback">{errors.accountOfficerBranchEncodedKey}</span>
                                                                                ) : null}
                                                                            </Col>
                                                                        </Form.Row>
                                                                    </div>
                                                                        ...
                                                                        <Form.Row>
                                                                            <Col>
                                                                                ...
                                                                                <Select
                                                                                    ...
                                                                                    onChange={(selected) => {
                                                                                        setFieldValue('associatedBranchEncodedKey', selected.value)
                                                                                    }}
                                                                                    onBlur={()=> setFieldTouched('associatedBranchEncodedKey', true)}
                                                                                    // onChange={(selectedLoanProduct) => {
                                                                                    //     this.setState({ selectedLoanProduct });
                                                                                    //     errors.productEncodedKey = null
                                                                                    //     values.productEncodedKey = selectedLoanProduct.value
                                                                                    // }}
                                                                                    className={errors.associatedBranchEncodedKey && touched.associatedBranchEncodedKey ? "is-invalid" : null}
                                                                                    ...
                                                                                    required
                                                                                />
                                                                                {errors.associatedBranchEncodedKey && touched.associatedBranchEncodedKey ? (
                                                                                    <span className="invalid-feedback">{errors.associatedBranchEncodedKey}</span>
                                                                                ) : null}
                                                                            </Col>
                                                                            <Col></Col>
                                                                        </Form.Row>
                                                            ...
                                                            <div className="footer-with-cta toleft">
                                                                ...
                                                                <Button
                                                                    type="submit"
                                                                    disabled={rescheduleALoanRequest.is_request_processing}>
                                                                        {rescheduleALoanRequest.is_request_processing?"Please wait...": "Refinance Loan Account"}
                                                                </Button>
                                                            </div>
                                                            {rescheduleALoanRequest.request_status === loanAndDepositsConstants.RESCHEDULE_LOAN_FAILURE && 
                                                                <Alert className="mt-20" variant="danger">{rescheduleALoanRequest.request_data.error} </Alert>
                                                            }

                                                            {rescheduleALoanRequest.request_status === loanAndDepositsConstants.RESCHEDULE_LOAN_SUCCESS && 
                                                                <Alert className="mt-20" variant="success">{rescheduleALoanRequest.request_data.response.data.message||"Reschedule was successful"} </Alert>
                                                            }
                                                        </Form>
                                                    )}
                                            </Formik>
            ...
            if(adminGetTransactionChannelsRequest.request_status=== administrationConstants.GET_TRANSACTION_CHANNELS_FAILURE){
                return (
                    <div className="loading-content card"> 
                                    ...
                                    <div className="col-sm-12">
                                        <div className="middle-content">
                                            <div className="full-pageforms w-60">
                                                {this.renderRescheduleLoanAccount()}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
function mapStateToProps(state) {
    return {
        ...
        rescheduleALoanReducer : state.loansReducers.rescheduleALoanReducer,
        ...
        getLoanSchedulePreviewReducer : state.loansReducers.getLoanSchedulePreviewReducer,
        getAClientLoanAccountReducer: state.loansReducers.getAClientLoanAccountReducer,
    };
}

export default connect(mapStateToProps)(RescheduleALoanAccount);