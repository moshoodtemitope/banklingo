                                                ...
                                                onSubmit={(values, { resetForm }) => {
                                                    if (this.state.isSubmitable) {
                                                        ...
                                                        loanAccountPayload = {
                                                            ...
                                                            refinanceDetails: {
                                                                topUpAmount: parseFloat(values.topUpAmount.replace(/,/g, '')),
                                                        ...
                                                        this.refinanceLoanAccount(loanAccountPayload)
                                                            .then(
                                                                () => {

                                                                    if (this.props.refianceALoanReducer.request_status === loanAndDepositsConstants.REFINANCE_LOAN_SUCCESS) {
                                                                        setTimeout(() => {
                                                                            // resetForm();
                                                                            // this.props.dispatch(loanActions.refianceALoan("CLEAR"))
                                                                        }, 3000);
                                                ...
                                                {({ handleSubmit,
                                                    ...
                                                    errors, }) => (
                                                        <Form
                                                            ...
                                                            <h3>Refinancing Loan Account ({loanData.accountNumber})</h3>
                                                            </div>
                                                            <Form.Row>
                                                                    ...
                                                                    <Form.Row>
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    delete this.loanSchedulePayload.refinaceInfo.interestBalance;
                                                                                    this.loanSchedulePayload.refinaceInfo.interestBalance = parseFloat(e.target.value.replace(/,/g, ''));
                                                                        ...
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.refinaceInfo.outstandingFees = parseFloat(e.target.value.replace(/,/g, ''));
                                                                    ...
                                                                    <Form.Row>
                                                                        <Col sm={6}>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                autoComplete="off"
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.refinaceInfo.outstandingPenalty = parseFloat(e.target.value.replace(/,/g, ''));
                                                                        ...
                                                                        <Col>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.refinaceInfo.outstandingPrincipal = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    ...
                                                                                    if(parseFloat(e.target.value.replace(/,/g, '')) < loanData.outstandingPrincipal){
                                                        ...
                                                        <Accordion defaultActiveKey="0">
                                                            ...
                                                            <Accordion.Collapse eventKey="0">
                                                                ...
                                                                <Form.Row>
                                                                        <Col>
                                                                            <Form.Label className="block-level">Top Up Amount (&#8358;)</Form.Label>
                                                                            <Form.Control
                                                                                type="text"
                                                                                autoComplete="off"
                                                                                // onChange={handleChange}
                                                                                onChange={(e) => {
                                                                                    this.loanSchedulePayload.refinaceInfo.topUpAmount = parseFloat(e.target.value.replace(/,/g, ''));
                                                                                    setFieldValue("topUpAmount", numberWithCommas(e.target.value));
                                                                                    if (e.target.value !== '') {
                                                                                        this.setState({ isscheduleError: false, topUpAmount:parseFloat(e.target.value.replace(/,/g, '')) })
                                                                                    }else{
                                                                                        this.setState({outstandingPrincipal: null})
                                                                                    }
                                                                                ...
                                                                                className={errors.topUpAmount && touched.topUpAmount ? "is-invalid" : null}
                                                                                name="topUpAmount" required
                                                                            />
                                                                            {/* <span className="input-helptext form-text">
                                                                                {this.selectedLoanProductDetails.loanAmountSetting.loanAmountMinimun !== null &&
                                                                                    <span>Min: &#8358;{numberWithCommas(this.selectedLoanProductDetails.loanAmountSetting.loanAmountMinimun)}</span>
                                                                    ...
                                                                    <div className="each-formsection">
                                                                        ...
                                                                        <Button 
                                                                            ...
                                                                            onClick={()=>{
                                                                                ...
                                                                                this.loanSchedulePayload.refinaceInfo.interestBalance=values.interestBalance;
                                                                                this.loanSchedulePayload.refinaceInfo.outstandingFees=values.outstandingFees;
                                                                                this.loanSchedulePayload.refinaceInfo.outstandingPenalty=values.outstandingPenalty;
                                                                                this.loanSchedulePayload.refinaceInfo.outstandingPrincipal=values.outstandingPrincipal;

                                                                                this.loanSchedulePayload.refinaceInfo.topUpAmount=values.topUpAmount;
                                                                                this.loanSchedulePayload.loanAmount = parseFloat(values.interestBalance.toString().replace(/,/g, ''))+
                                                                                                                        ...
                                                                                                                        parseFloat(values.topUpAmount.replace(/,/g, ''))
                                                            ...
                                                            <div className="footer-with-cta toleft">
                                                                ...
                                                                <Button
                                                                    ...
                                                                    disabled={refianceALoanRequest.is_request_processing}>
                                                                        {refianceALoanRequest.is_request_processing?"Please wait...": "Refinance Loan Account"}
                                                                </Button>
                                                            </div>
                                                            {refianceALoanRequest.request_status === loanAndDepositsConstants.REFINANCE_LOAN_FAILURE && 
                                                                <Alert className="mt-20" variant="danger">{refianceALoanRequest.request_data.error} </Alert>
                                                            }

                                                            {refianceALoanRequest.request_status === loanAndDepositsConstants.REFINANCE_LOAN_SUCCESS && 
                                                                <Alert className="mt-20" variant="success">{refianceALoanRequest.request_data.response.data.message||"Refinance was successful"} </Alert>
                                                            }
                                                        </Form>
                                                    )}
                                            </Formik>
