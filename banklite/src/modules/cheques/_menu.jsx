...
import {cheque_tab_list} from '../../shared/elements/mainmenu/menu_structures/cheques_tab_list'
class ChequeNav extends React.Component{

    render() {
        let userPermissions =  JSON.parse(localStorage.getItem("x-u-perm"));
        let allMenu = cheque_tab_list,
            allMenuGroups = [],
