...
class DepositManagement extends React.Component {
  ...
  setPagesize = (PageSize, tempData) => {
    ...
    let paramters = `FullDetails=${FullDetails}&PageSize=${sizeOfPage}&CurrentPage=${CurrentPage}&BranchId=${BranchId}&StartDate=${startDate}&endDate=${endDate}&SearchText=${SearchText}`;
  ...
  renderDeposits = () => {
    ...
    let saveRequestData =
      getDepositsRequest.request_data !== undefined
        ? getDepositsRequest.request_data.tempData
        : null;
