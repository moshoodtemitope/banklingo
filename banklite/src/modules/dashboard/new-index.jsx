...
class DashboardLanding extends React.Component {
          ...
          return (
            <div className='all-stats-wrap'>
              ...
              <div className='each-stat'>
                <div className='stat-data card'>
                  <h4 className='stat-value'>
                    {numberWithCommas(allDashboardStat.numberOfGroups)}
                  </h4>
                  <span className='stat-text'>Number of Groups</span>
                </div>
              </div>
              <div className='each-stat'>
                <div className='stat-data card'>
                  <h4 className='stat-value'>
                    {numberWithCommas(allDashboardStat.numberOfOverDrafts)}
                  </h4>
              ...
              <div className='each-stat'>
                <div className='stat-data card'>
                  <h4 className='stat-value'>
                    {numberWithCommas(allDashboardStat.parAbove30Days)}
                  </h4>
  ...
  postNewTransaction = async (txtnPayload, transactiontype) => {
    ...
    await dispatch(
      dashboardActions.postATransaction(txtnPayload, transactiontype)
    );
  };
  ...
  handlecloseUndoCloseToTill = async (requestPayload, action) => {
    ...
    await dispatch(
      dashboardActions.closeUndoCloseToTill(requestPayload, action)
    );
  };
  handleAddRemoveCashToTill = async (requestPayload, action) => {
    ...
    await dispatch(
      dashboardActions.addRemoveCashToTill(requestPayload, action)
    );
  };

  renderOpenTillWrap = () => {
    if (
      this.props.fetchAllTillsReducer.request_status ===
      dashboardConstants.GET_ALL_TILLS_SUCCESS
    ) {
      let validationSchema = Yup.object().shape({
        // tillId: Yup.string()
        //     .required('Required'),
        mimimumbalance: Yup.string().required('Required'),
        maximumBalance: Yup.string().required('Required'),
        openingAmount: Yup.string().required('Required'),
      });
      let tellersData = this.props.fetchAllTillsReducer.request_data.response4
          .data,
        currencyData = this.props.fetchAllTillsReducer.request_data.response5
          .data,
        allTellers = [],
        allCurrencies = [],
        ...
        <div className='slidein-wrap'>
          ...
          <div className='slidein-form' ref={this.setWrapperRef}>
            <div className='slide-in-heading'>
              <h3>Open Till</h3>
              <div className='close-slidein' onClick={this.closeOpenTill}>
                X
              </div>
            </div>
              ...
              <Formik
                ...
                onSubmit={(values, { resetForm }) => {
                  ...
                  let requestPayload = {
                    ...
                    maximumBalance: parseFloat(
                      values.maximumBalance.replace(/,/g, '')
                    ),
                    mimimumbalance: parseFloat(
                      values.mimimumbalance.replace(/,/g, '')
                    ),
                    openingBalance: parseFloat(
                      values.openingAmount.replace(/,/g, '')
                    ),
                  ...
                  this.handleOpenTill(requestPayload).then(() => {
                    if (
                      this.props.openATillReducer.request_status ===
                      dashboardConstants.OPEN_A_TILL_SUCCESS
                    ) {
                      this.getDashboardData();
                    }
                  });
                ...
                {({
                  ...
                  <Form noValidate onSubmit={handleSubmit}>
                    ...
                    <Form.Group>
                      ...
                      {errors.mimimumbalance && touched.mimimumbalance ? (
                        <span className='invalid-feedback'>
                          {errors.mimimumbalance}
                        </span>
                      ) : null}
                    </Form.Group>
                    <Form.Group>
                      <Form.Label className='block-level'>
                        Balance Constant Type
                      </Form.Label>
                      <div className='select-drop'>
                        <Select
                          options={allOptions}
                          onChange={(selectedOption) => {
                            ...
                            values.tillBalanceConstraintType =
                              selectedOption.value;
                          }}
                          className={
                            errors.tillBalanceConstraintType &&
                            touched.tillBalanceConstraintType
                              ? 'is-invalid'
                              : null
                          }
                    ...
                    <div className='mt-50'>
                      <div className='footer-with-cta'>
                        {openATillRequest.request_status !==
                          dashboardConstants.OPEN_A_TILL_SUCCESS && (
                          <Button
                            type='submit'
                            disabled={openATillRequest.is_request_processing}
                          >
                            {openATillRequest.is_request_processing
                              ? 'Please wait...'
                              : 'Open Till'}
                          </Button>
                        )}
                    ...
                    {openATillRequest.request_status ===
                      ...
                      <Alert variant='success'>
                        {openATillRequest.request_data.response.data.message &&
                          openATillRequest.request_data.response.data.message}
                        {!openATillRequest.request_data.response.data.message &&
                          `Till ${openATillRequest.request_data.response.data.tillId} was successfully opened`}
                      </Alert>
                    )}
                    {openATillRequest.request_status ===
                      dashboardConstants.OPEN_A_TILL_FAILURE && (
  ...
  renderAddRemoveCashToTillWrap = (tillData, action) => {
    ...
    return (
      <div className='slidein-wrap'>
        ...
        <div className='slidein-form' ref={this.setWrapperRef}>
          <div className='slide-in-heading'>
            {action === 'add' && <h3>Add Cash - {tillData.tillId}</h3>}
            {action === 'remove' && <h3>Remove Cash - {tillData.tillId}</h3>}

            <div className='close-slidein' onClick={this.closeAddCashToTill}>
              X
            </div>
          </div>
          {this.props.addRemoveCashToTillReducer.request_status !==
            dashboardConstants.ADD_REMOVE_CASH_TO_TILL_SUCCESS && (
            <div className='formdetails'>
              ...
              <div className='each-detail'>
                ...
                <div className='detail-value'>
                  {numberWithCommas(tillData.balance, true)}
                </div>
              </div>
            </div>
          )}
          ...
          <div className='slidein-formwrap'>
            <Formik
              ...
              onSubmit={(values, { resetForm }) => {
                ...
                this.handleAddRemoveCashToTill(requestPayload, action).then(
                  () => {
                    if (
                      this.props.addRemoveCashToTillReducer.request_status ===
                      dashboardConstants.ADD_REMOVE_CASH_TO_TILL_SUCCESS
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  {this.props.addRemoveCashToTillReducer.request_status !==
                    ...
                    <div>
                      ...
                      <div className='mt-50'>
                        <div className='footer-with-cta'>
                          {addRemoveCashToTillRequest.request_status !==
                            dashboardConstants.ADD_REMOVE_CASH_TO_TILL_SUCCESS && (
                            <Button
                              type='submit'
                              disabled={
                                addRemoveCashToTillRequest.is_request_processing
                              }
                            >
                              {addRemoveCashToTillRequest.is_request_processing
                                ? 'Please wait...'
                  ...
                  {addRemoveCashToTillRequest.request_status ===
                    ...
                    <Alert variant='success'>
                      {
                        addRemoveCashToTillRequest.request_data.response.data
                          .message
                      }
                    </Alert>
                  )}
                  {addRemoveCashToTillRequest.request_status ===
                    dashboardConstants.ADD_REMOVE_CASH_TO_TILL_FAILURE && (
                    <Alert variant='danger'>
      ...
      <div className='slidein-wrap'>
        ...
        <div className='slidein-form' ref={this.setWrapperRef}>
          <div className='slide-in-heading'>
            ...
            <div className='close-slidein' onClick={this.hideCloseTill}>
              X
            </div>
          </div>
          {this.props.closeUndoCloseToTillReducer.request_status ===
            dashboardConstants.CLOSE_UNDOCLOSE_TILL_SUCCESS && (
            <div className='formdetails'>
              <div className='each-detail'>
                <div className='detail-title'>Till ID</div>
                <div className='detail-value'>{tillData.tillId}</div>
          ...
          <div className='slidein-formwrap'>
            <Formik
              ...
              onSubmit={(values, { resetForm }) => {
                ...
                this.handlecloseUndoCloseToTill(
                  requestPayload,
                  this.state.tillAction
                ).then(() => {
                  if (
                    this.props.closeUndoCloseToTillReducer.request_status ===
                    dashboardConstants.CLOSE_UNDOCLOSE_TILL_SUCCESS
            ...
            >
              {({
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  <div className='mt-50'>
                    <div className='footer-with-cta'>
                      {closeUndoCloseToTillRequest.request_status !==
                        dashboardConstants.CLOSE_UNDOCLOSE_TILL_SUCCESS && (
                        <Button
                          type='submit'
                          disabled={
                            closeUndoCloseToTillRequest.is_request_processing
                          }
                        >
                          {closeUndoCloseToTillRequest.is_request_processing
                            ? 'Please wait...'
                  ...
                  {closeUndoCloseToTillRequest.request_status ===
                    ...
                    <Alert variant='success'>
                      {
                        closeUndoCloseToTillRequest.request_data.response.data
                          .message
                      }
                    </Alert>
                  )}
                  {closeUndoCloseToTillRequest.request_status ===
                    dashboardConstants.CLOSE_UNDOCLOSE_TILL_FAILURE && (
                    <Alert variant='danger'>
      ...
      <div className='slidein-wrap'>
        ...
        <div className='slidein-form' ref={this.setWrapperRef}>
          <div className='slide-in-heading'>
            ...
            <div className='close-slidein' onClick={this.hideViewTill}>
              X
            </div>
          </div>
          ...
          <div className='formdetails'>
            <div className='each-detail'>
              ...
              <div className='detail-value'>
                {tillData.tillAccountStateDescription}
              </div>
            </div>
            {tillData.tillAccountState === 1 && (
              <div className='each-detail'>
                ...
                <div className='detail-value'>
                  {getDateFromISO(tillData.dateOpened)}
                </div>
              </div>
            )}
            {tillData.tillAccountState === 2 && (
              <div className='each-detail'>
                ...
                <div className='detail-value'>
                  {getDateFromISO(tillData.dateClosed)}
                </div>
              </div>
            )}
            <div className='each-detail'>
            ...
            <div className='each-detail'>
              ...
              <div className='detail-value'>
                {numberWithCommas(tillData.balance, true)}{' '}
                {tillData.currencyCode}
              </div>
            </div>
            <div className='each-detail'>
              <div className='detail-title'>Minimum Balance</div>
              <div className='detail-value'>
                {numberWithCommas(tillData.mimimumbalance, true)}{' '}
                {tillData.currencyCode}
              </div>
            </div>
            <div className='each-detail'>
              ...
              <div className='detail-value'>
                {numberWithCommas(tillData.maximumBalance, true)}{' '}
                {tillData.currencyCode}
              </div>
            </div>
          </div>
            ...
            >
              {({
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  <div className='mt-50'>
                    <div className='footer-with-cta'>
                      <Button variant='secondary' onClick={this.hideViewTill}>
                        Close
                      </Button>
                    </div>
                  </div>
      ...
      <div className='slidein-wrap'>
        ...
        <div className='slidein-form' ref={this.setWrapperRef}>
          <div className='slide-in-heading'>
            ...
            <div className='close-slidein' onClick={this.hideViewCutomer}>
              X
            </div>
          </div>
                    ...
                    <div className='activity-wrap'>
                      <div className='action-info'>
                        <span className='username'>
                          <NavLink
                            to={`/user/${eachActivity.affectedCustomerEncodedKey}`}
                          >
                            {eachActivity.userName}
                          </NavLink>
                        </span>
  ...
  renderIndicators = () => {
    let getDashboardStatsRequest = this.props.getDashboardStats;
    if (
      getDashboardStatsRequest.request_status ===
      dashboardConstants.GET_DASHOBOARD_DATA_PENDING
    ) {
      return (
    ...
    if (
      getDashboardStatsRequest.request_status ===
      dashboardConstants.GET_DASHOBOARD_DATA_SUCCESS
    ) {
      let dashboardData = this.props.getDashboardStats.request_data.response
        .data;
      return (
        <div className='each-card mt-20'>
          <div className='each-card-heading'>
          ...
          <div className='each-card-content'>
            <div className='all-indicators'>
              ...
              <div className='each-indicator'>
                <div>
                  <h4>
                    {numberWithCommas(dashboardData.loansAwaitingApproval)}
                  </h4>
              ...
              <div className='each-indicator'>
                <div>
                  <h4>
                    {numberWithCommas(dashboardData.totalLoanPortfolio, true)}
                  </h4>
    ...
    if (
      getDashboardStatsRequest.request_status ===
      dashboardConstants.GET_DASHOBOARD_DATA_FAILURE
    ) {
      return (
        <div className='each-card mt-20'>
          <div className='each-card-heading'>
      ...
      <div className='slidein-wrap'>
        ...
        <div className='slidein-form' ref={this.setWrapperRef}>
          <div className='slide-in-heading'>
            ...
            <div className='close-slidein' onClick={this.hideViewAccount}>
              X
            </div>
          </div>
          ...
          <div className='formdetails'>
            ...
            <div className='each-detail'>
              <div className='detail-title'>Account Status</div>
              <div className='detail-value'>
                {accountToView.stateDescription}
              </div>
            </div>
          </div>
    ...
    if (inputValue.length >= 1) {
      return this.getSearchedAccountResults(inputValue).then(() => {
        if (
          ...
          let searchResultsData = this.props.searchAccountNumbersReducer
          ...
          this.setState({
            ...
            defaultAccountOptions: searchResultsData,
          });
  ...
  renderTillTransactions = () => {
    ...
    if (
      fetchTillTransactionsRequest.request_status ===
      dashboardConstants.GET_TILL_TRANSACTIONS_PENDING
    ) {
      return (
    ...
    if (
      fetchTillTransactionsRequest.request_status ===
      dashboardConstants.GET_TILL_TRANSACTIONS_SUCCESS
    ) {
      let fetchTillTransactionsData =
        fetchTillTransactionsRequest.request_data.response.data;
      return (
        <div className='tellering-section'>
          <div className='txtn-logs'>
            <div className='each-card mt-20'>
                    ...
                    {fetchTillTransactionsData.result.map((eachData, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            {numberWithCommas(eachData.transactionAmount, true)}
                          </td>
                          <td>
    ...
    if (
      fetchTillTransactionsRequest.request_status ===
      dashboardConstants.GET_TILL_TRANSACTIONS_FAILURE
    ) {
      return (
        <div className='tellering-section'>
          <div className='txtn-logs'>
  ...
  renderPostTransaction = () => {
    ...
    let validationSchema = Yup.object().shape({
      ...
      txtnType: Yup.string().required('Required'),
      clientEncodedKey: Yup.string().required('Required'),
      amount: Yup.string().required('Required'),
    });
    let {
      selectedCustomer,
    ...
    let allLoggedOnTills = this.props.fetchLoggedonTillsReducer.request_data
    ...
    if (
      ...
      this.state.selectedOption.searchItemType === 2
    ) {
      allTxtn = [
    ...
    if (
      this.state.selectedOption &&
      this.state.selectedOption.searchItemType === 3
    ) {
      allTxtn = [
        { label: 'Deposit', value: 2 },
        ...
        <div className='tiller-record-form'>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              this.postNewTransaction(requestPayload, transactionAction).then(
                () => {
                  if (
                    this.props.postATransactionReducer.request_status ===
                    dashboardConstants.POST_TRANSACTION_SUCCESS
                  ) {
                    resetForm();
                    this.fetchTillTransactions(
                      this.state.selectedTillData.tillId
                    );
                  }
                }
              );
              ...
              <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <div className='withasync'>
                    ...
                    <div>
                      ...
                      {this.state.selectedCustomer && (
                        <span
                          onClick={() =>
                            this.showViewCustomer(this.selectedCustomer)
                          }
                        >
                          View Customer
                        </span>
                ...
                <Form.Group>
                  ...
                  <div className='txtn-wrap'>
                    ...
                    {this.state.selectedOption && (
                      <span
                        onClick={() => {
                          this.showViewAccount(this.state.selectedCustomer);
                        }}
                      >
                        View Account
                      </span>
                ...
                <div className='mr-10'>
                  <div className='footer-with-cta'>
                    ...
                    >
                      {postATransactionRequest.is_request_processing
                        ? 'Please wait...'
                        : 'Post transaction'}
                    </Button>
                    <Button
                ...
                {postATransactionRequest.request_status ===
                  dashboardConstants.POST_TRANSACTION_SUCCESS && (
                  <Alert variant='success'>
                    {postATransactionRequest.request_data.response.data
                      .message &&
                      postATransactionRequest.request_data.response.data
                        .message}
                    {!postATransactionRequest.request_data.response.data
                      .message && `Transaction was posted`}
                  </Alert>
                )}
                {postATransactionRequest.request_status ===
                  dashboardConstants.POST_TRANSACTION_FAILURE && (
                  <Alert variant='danger'>
  ...
  renderSelectedTillDetails = () => {
    return (
      <div>
        {this.state.selectedTillData &&
          this.props.fetchTillTransactionsReducer.request_status ===
            dashboardConstants.GET_TILL_TRANSACTIONS_SUCCESS && (
            <div className='tellering-section'>
                    ...
                    <div className='all-indicators'>
                      ...
                      <div className='each-indicator'>
                        <div>
                          <h4>
                            {
                              this.props.fetchTillTransactionsReducer
                                .request_data.response.data.result.length
                            }
                          </h4>
                      ...
                      <div className='each-indicator'>
                        <div>
                          <h4>
                            {numberWithCommas(
                              this.state.selectedTillData.balance,
                              true
                            )}
                          </h4>
  ...
  renderManageTellers = () => {
    if (
      this.props.fetchAllTillsReducer.request_status ===
      dashboardConstants.GET_ALL_TILLS_PENDING
    ) {
      return (
        <div className='each-card mt-20'>
          <div className='each-card-heading'>
            ...
            <div className='all-indicators forteller'>
              <div className='each-indicator'>
                <div>
                  <h4>
                    {
                      this.props.fetchAllTillsReducer.request_data.response2
                        .data.openedTills
                    }
                  </h4>
              ...
              {this.props.fetchAllTillsReducer.request_data.response2.data.result.map(
                (eachData, index) => {
                  return (
                    <div className='each-indicator with-actions' key={index}>
                      <div>
                        <h4>
                          <span>{eachData.tillUser}</span>{' '}
                          <span>
                            {' '}
                            {numberWithCommas(eachData.balance, true)}{' '}
                            {eachData.currencyCode}
                          </span>{' '}
                        </h4>
                        <div className='indicator-txt'>
    ...
    if (
      this.props.fetchAllTillsReducer.request_status ===
      dashboardConstants.GET_ALL_TILLS_FAILURE
    ) {
      return (
        <div className='each-card mt-20'>
          <div className='each-card-heading'>
  ...
  renderLoggedOnTillsAndTxtn = () => {
    if (
      this.props.fetchLoggedonTillsReducer.request_status ===
      dashboardConstants.GET_LOGGEDON_TILLS_PENDING
    ) {
      return (
        <div>
    ...
    if (
      this.props.fetchLoggedonTillsReducer.request_status ===
      dashboardConstants.GET_LOGGEDON_TILLS_SUCCESS
    ) {
      let allTxtn;
              ...
              <div className='tellerid-wrap'>
                ...
                <div className='select-tillid'>
                  <select
                    id='tildId'
                    onChange={(e) => {
                      let selectedTillData = allLoggedOnTills.filter(
                        (eachTill) => eachTill.tillId === e.target.value
                      )[0];
                      // console.log("zelect is", selectedTillData)
                      this.fetchTillTransactions(e.target.value);
                      this.setState({
                        selectedTill: e.target.value,
                        selectedTillData,
                      });
                    }}
                    name='selectedTill'
                  ...
                  >
                    ...
                    {allMyTills.map((eachTill, index) => {
                      return (
                        <option key={index} value={eachTill}>
                          {eachTill}
                        </option>
                      );
                    })}
    ...
    if (
      this.props.fetchLoggedonTillsReducer.request_status ===
      dashboardConstants.GET_LOGGEDON_TILLS_FAILURE
    ) {
      return (
        <div>
          <div className='each-card'>
  ...
  renderDashboardWrap = () => {
    return (
      <div className='dashboard-container'>
        <div className='dashboard-section'>
          <div className='each-card'>
            ...
            <div className='each-card-content'>
              ...
              <div className='task-stat-msg'>
                You don't have any tasks due at the moment
              </div>
            </div>
          </div>
        ...
        <div className='dashboard-section'>{this.renderTellerManagement()}</div>
      </div>
    );
  };
        ...
        <InnerPageContainer {...this.props}>
          <div className='content-wrapper'>
            ...
            <div className='module-content grayed-bg'>
              ...
              {this.state.addCashToTill &&
                this.renderAddRemoveCashToTillWrap(
                  this.state.tillActionData,
                  this.state.tillAction
                )}
              {this.state.closeUndoCloseTill &&
                this.renderCloseUndoCloseTillWrap(
                  this.state.tillActionData,
                  this.state.tillAction
                )}
              {this.state.closeViewTill &&
                this.renderViewTillWrap(
                  this.state.tillToView,
                  this.state.allTills
                )}
              {this.state.closeViewCustomer &&
                this.renderViewCustomerWrap(this.state.selectedCustomer)}
              {this.state.closeViewAccount &&
                this.renderViewAccountWrap(this.state.selectedCustomer)}
              <div className='content-container'>
...
function mapStateToProps(state) {
  return {
    ...
    fetchLoggedonTillsReducer:
      state.dashboardReducers.fetchLoggedonTillsReducer,
    ...
    fetchTillTransactionsReducer:
      state.dashboardReducers.fetchTillTransactionsReducer,
    addRemoveCashToTillReducer:
      state.dashboardReducers.addRemoveCashToTillReducer,
    closeUndoCloseToTillReducer:
      state.dashboardReducers.closeUndoCloseToTillReducer,
  };
}
