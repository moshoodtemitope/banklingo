...
class ManageEmployeeInfo extends React.Component {
        ...
        return (
            <Modal show={showCreateNewRecord} onHide={this.handleCloseNewRecord} size="lg" centered="true" dialogClassName="modal-40w withcentered-heading" animation={true}>
                ...
                <Modal.Body>
                                ...
                                <Form noValidate
                                    ...
                                    <div className="footer-with-cta toleft">
                                        ...
                                        <Button
                                            type="submit"
                                            disabled={createEmployeeInfoRequest.is_request_processing}>
                                            {createEmployeeInfoRequest.is_request_processing ? "Please wait..." : "Create"}
                                        </Button>
                                    </div>
                                </Form>
                            )
                    ...
                    {createEmployeeInfoRequest.request_status === platformConstants.ADD_A_PAYROLLINFO_SUCCESS &&
                        <Alert variant="success">
                            {createEmployeeInfoRequest.request_data.response.data.message}
                        </Alert>
                    }
                    {createEmployeeInfoRequest.request_status === platformConstants.ADD_A_PAYROLLINFO_FAILURE &&
    ...
    updateRecordPopUp = (updateType) => {
        ...
        allPayGroups.map((eachAccount, index)=>{
            allPayGroupList.push({value:eachAccount.id, label:eachAccount.accountDescription})
        })
                                ...
                                <tbody>
                                    {
                                        saveRequestData.map((eachItem, index) => {
                                            return (
                                                <Fragment key={index}>
                                                    <tr>
                                                        <td>{eachItem.firstName} {eachItem.lastName} {eachItem.middleName}</td>
