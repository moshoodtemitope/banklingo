...
class ManageCompanyInfo extends React.Component {
  ...
  createNewRecordPopUp = () => {
    ...
    let checkValidationSchema = Yup.object().shape({
      ...
      companyDomains: Yup.string().required('Required'),
      companyName: Yup.string().required('Required'),
      maximumLoanAmount: Yup.string().required('Required'),
    });
    return (
      <Modal
      ...
      >
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              let requestPayload = {
                ...
                maximumLoanAmount: parseFloat(
                  values.maximumLoanAmount.replace(/,/g, '')
                ),
              };

              this.createNewRecord(requestPayload).then(() => {
                if (
                  this.props.newCompanyInfoReducer.request_status ===
                  platformConstants.ADD_A_COMPANY_INFO_SUCCESS
                ) {
                  resetForm();
                  this.loadInitialData();
                }
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={newCompanyInfoRequest.is_request_processing}
                    >
                      {newCompanyInfoRequest.is_request_processing
                        ? 'Please wait...'
                        : 'Create'}
                    </Button>
                  </div>
          ...
          {newCompanyInfoRequest.request_status ===
            platformConstants.ADD_A_COMPANY_INFO_SUCCESS && (
          ...
          {newCompanyInfoRequest.request_status ===
            platformConstants.ADD_A_COMPANY_INFO_FAILURE && (
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              if (this.state.updateType === 'edit') {
                requestPayload = {
                  ...
                  companyName: values.companyName,
                  maximumLoanAmount: parseFloat(
                    values.maximumLoanAmount.toString().replace(/,/g, '')
                  ),
              ...
              this.updateARecord(
                ...
                if (
                  this.props.updateCompanyInfoReducer.request_status ===
                  platformConstants.UPDATE_A_COMPANY_INFO_SUCCESS
                ) {
                  this.loadInitialData();
                }
              });
                ...
                <Form noValidate onSubmit={handleSubmit}>
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        if (this.state.updateType !== 'edit') {
                          setFieldValue(
                            'companyCategory',
                            recordToUpdate.companyCategory
                          );
                        } else {
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        if (this.state.updateType !== 'edit') {
                          setFieldValue(
                            'maximumLoanAmount',
                            recordToUpdate.maximumLoanAmount
                          );
                        } else {
                  ...
                  <div className='footer-with-cta toleft'>
                    ...
                    <Button
                      ...
                      disabled={updateCompanyInfoRequest.is_request_processing}
                    >
                      {updateCompanyInfoRequest.is_request_processing &&
                        'Please wait...'}
                      {!updateCompanyInfoRequest.is_request_processing &&
                        this.state.updateType === 'edit' &&
                        'Update'}
          ...
          {updateCompanyInfoRequest.request_status ===
            platformConstants.UPDATE_A_COMPANY_INFO_SUCCESS && (
            <Alert variant='success'>
          ...
          {updateCompanyInfoRequest.request_status ===
            platformConstants.UPDATE_A_COMPANY_INFO_FAILURE && (
            <Alert variant='danger'>
  ...
  renderContentWrap = () => {
    ...
    let saveRequestData =
      getAllCompanyInfoRequest.request_data !== undefined
        ? getAllCompanyInfoRequest.request_data.tempData
        : null;
    ...
    switch (getAllCompanyInfoRequest.request_status) {
                    ...
                    return (
                      <Fragment key={index}>
                        <tr>
                          ...
                          <td>
                            {numberWithCommas(eachItem.maximumLoanAmount, true)}
                          </td>
                          ...
                          <td>
                            ...
                            >
                              ...
                              {eachItem.companyStatus === 0 && (
                                <Dropdown.Item eventKey='1'>
                                  Activate
                                </Dropdown.Item>
                              )}
                              {eachItem.companyStatus === 1 && (
                                <Dropdown.Item eventKey='1'>
                                  Deactivate
                                </Dropdown.Item>
                              )}
      ...
      case platformConstants.GET_ALL_COMPANY_INFO_SUCCESS:
        let allFetchedData =
          getAllCompanyInfoRequest.request_data.response.data;
