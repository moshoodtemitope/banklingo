...
class BalanceSheet extends React.Component {
  ...
  fetchBalanceSheet = (e, tempData) => {
    ...
    let saveRequestData =
      getBalanceSheetRequest.request_data !== undefined
        ? getBalanceSheetRequest.request_data.response.data.result
        : null;
      ...
      <div className='heading-actions'>
        <Formik
          ...
          onSubmit={(values, { resetForm }, errors) => {
            ...
            if (tempData) {
              ...
              if (saveRequestData) {
                dispatch(
                  acoountingActions.getBalanceSheet(payload, saveRequestData)
                );
              } else {
                dispatch(acoountingActions.getBalanceSheet(payload));
              }
        ...
        >
          {({
            ...
            <Form className='one-liner' noValidate onSubmit={handleSubmit}>
              <Form.Group
                controlId='periodOptionChosen'
                className={
              ...
              >
                ...
                <DatePickerEx
                  ...
                  onChange={(e) => {
                    this.handleStartDatePicker(e);
                    setFieldValue('dateChosen', e);
                  }}
              ...
              <Button
                ...
                type='submit'
              >
                {getBalanceSheetRequest.is_request_processing
                  ? 'Generating...'
                  : 'Generate Balance Sheet'}{' '}
              </Button>
              <div className='actions-wrap'>
                <Button
                  onClick={this.exportBalanceSheet}
  ...
  renderBalanceSheet = () => {
    ...
    let saveRequestData =
      getBalanceSheetRequest.request_data !== undefined
        ? getBalanceSheetRequest.request_data.tempData
        : null;
    ...
    switch (getBalanceSheetRequest.request_status) {
                  ...
                  return (
                    <tbody key={`key-${index}`}>
                      <tr className='sheetheading'>
                        <td colSpan='3'>
                          {' '}
                          <h5>{eachResult.accountTypeDescription}</h5>
                        </td>
                      </tr>
                      {eachResult.balanceSheetModels.map(
                        (eachModelData, keyIndex) => {
      ...
      case accountingConstants.GET_BALANCE_SHEET_SUCCESS:
        let getBalanceSheetData =
            getBalanceSheetRequest.request_data.response.data,
