...
class LoanProductInfoContainer extends React.Component {
    ...
    renderProductDetailsHeading = ()=>{
        ...
        if(getSingleLoanProductsRequest.request_status===productsConstants.GET_A_LOAN_PRODUCT_PENDING){
        ...
        if(getSingleLoanProductsRequest.request_status===productsConstants.GET_A_LOAN_PRODUCT_SUCCESS){
                ...
                // console.log("dsdsdsdsd", getSingleLoanProductsRequest);
                let productDetails = getSingleLoanProductsRequest.request_data.response.data;
        ...
        if(getSingleLoanProductsRequest.request_status===productsConstants.GET_A_LOAN_PRODUCT_FAILURE){

            return(
                <div className="loading-text errormsg"> {getSingleLoanProductsRequest.request_data.error}</div>
            )
        }
             ...
             <Fragment>
                <InnerPageContainer {...this.props}>
                    <div className="content-wrapper">
                        ...
                        {this.props.children}
                        <Route exact to='/loanproduct/:productid'  component={LoanProductContainer} /> 
