...
export class SetDeleteLoanFeeModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    let deleteLoanFeeRequestData = this.props.deleteLoanFeeRequestData;
        ...
        <Formik
          ...
          onSubmit={(values, { resetForm }) => {
            let deleteDepositFeePayload = {
              loanSavingFeeId: this.props.loanSavingFeeId,
            };
            this.props
              .handleDeleteLoanFee(
              ...
              .then(() => {
                if (
                  this.props.deleteLoanFeeRequestData.request_status ===
                  productsConstants.DELETE_A_LOAN_PRODUCT_FEE_SUCCESS
                ) {
                  resetForm();
                  setTimeout(() => {
                    this.props.dispatch(productActions.deleteLoanFee("CLEAR"));
                ...
                if (
                  this.props.deleteLoanFeeRequestData.request_status ===
                  productsConstants.DELETE_A_LOAN_PRODUCT_FEE_FAILURE
                ) {
                  resetForm();
                  setTimeout(() => {
                    this.props.dispatch(productActions.deleteLoanFee("CLEAR"));
          ...
          {({
            ...
            <Form noValidate onSubmit={handleSubmit} className="">
              ...
              <Modal.Body>
                ...
                {deleteLoanFeeRequestData.request_status ===
                  productsConstants.DELETE_A_LOAN_PRODUCT_FEE_SUCCESS && (
                  <Alert variant="success" className="w-65 mlr-auto">
                    {
                      deleteLoanFeeRequestData.request_data?.response?.data
                        .message
                    }
                  </Alert>
                )}
                {deleteLoanFeeRequestData.request_status ===
                  productsConstants.DELETE_A_LOAN_PRODUCT_FEE_FAILURE &&
                  deleteLoanFeeRequestData.request_data.error && (
              ...
              <Modal.Footer>
                ...
                <Button
                  variant="success"
                  type="submit"
                  disabled={deleteLoanFeeRequestData.is_request_processing}
                >
                  {deleteLoanFeeRequestData.is_request_processing
                    ? "Please wait..."
                    : `Delete`}
                </Button>
              </Modal.Footer>
...
export default connect(mapStateToProps)(SetDeleteLoanFeeModal);
