...
class PlatformPayrollGroup extends React.Component {
        ...
        return (
            <Modal show={showCreateNewRecord} onHide={this.handleCloseNewRecord} size="lg" centered="true" dialogClassName="modal-40w withcentered-heading" animation={true}>
                ...
                <Modal.Body>
                    <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                            ...
                            this.createNewRecord(requestPayload)
                                .then(
                                    () => {
                                        if (this.props.createAPayrollGroupReducer.request_status === platformConstants.ADD_A_PAYROLLGROUP_SUCCESS) {
                                            resetForm();
                                            this.loadInitialData();
                                        }
                        ...
                        {({ handleSubmit,
                            ...
                            return (
                                <Form noValidate
                                    ...
                                    <Form.Row>
                                        ...
                                        <Col>
                                            ...
                                            <Form.Control type="text"
                                                ...
                                                className={errors.groupName && touched.groupName ? "is-invalid h-38px" : "h-38px"}
                                                name="groupName"
                                                required />
                                        ...
                                        <Col>
                                            <Form.Label className="block-level">Group Code</Form.Label>
                                            <Form.Control type="text"
                                                onChange={handleChange}
                                                value={values.groupCode}
                                                className={errors.groupCode && touched.groupCode ? "is-invalid h-38px" : "h-38px"}
                                                name="groupCode"
                                                required />

                                            {errors.groupCode && touched.groupCode ? (
                                                <span className="invalid-feedback">{errors.groupCode}</span>
                                            ) : null}
                                    ...
                                    <Form.Row>
                                        <Col>
                                            <Form.Label className="block-level">Employee Number Label </Form.Label>
                                            <Form.Control type="text"
                                                onChange={handleChange}
                                                value={values.employeeNumberLabel}
                                                className={errors.employeeNumberLabel && touched.employeeNumberLabel ? "is-invalid h-38px" : "h-38px"}
                                    ...
                                    <div className="footer-with-cta toleft">
                                        <Button
                                            disabled={createAPayrollGroupRequest.is_request_processing}
                                            variant="secondary" className="grayed-out" onClick={this.handleCloseNewRecord}>Cancel</Button>
                                        <Button
                                            type="submit"
                                            disabled={createAPayrollGroupRequest.is_request_processing}>
                                            {createAPayrollGroupRequest.is_request_processing ? "Please wait..." : "Create"}
                                        </Button>
                                    </div>
                                </Form>
                            )
                    ...
                    {createAPayrollGroupRequest.request_status === platformConstants.ADD_A_PAYROLLGROUP_SUCCESS &&
                        <Alert variant="success">
                            {createAPayrollGroupRequest.request_data.response.data.message}
                        </Alert>
                    }
                    {createAPayrollGroupRequest.request_status === platformConstants.ADD_A_PAYROLLGROUP_FAILURE &&
    ...
    updateRecordPopUp = (updateType) => {
        ...
        let updateAPayrollGroupReducerRequest = this.props.updateAPayrollGroupReducer;
        ...
        return (
            <Modal show={showEditRecord} onHide={this.handleEditRecordClose} size="lg" centered="true" dialogClassName="modal-40w withcentered-heading" animation={true}>
                ...
                <Modal.Body>
                    <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                            ...
                            this.updateARecord(requestPayload, recordToUpdate.encodedKey)
                                .then(
                                    () => {
                                        if (this.props.updateAPayrollGroupReducer.request_status === platformConstants.UPDATE_A_PAYROLLGROUP_SUCCESS) {
                        ...
                        {({ handleSubmit,
                            ...
                            return (
                                <Form noValidate
                                    ...
                                    <Form.Row>
                                        <Col>
                                            ...
                                            <Form.Control type="text"
                                                onChange={(e) => {
                                                    if (this.state.updateType !== "edit") {
                                                        setFieldValue("groupName", recordToUpdate.groupName)
                                                    } else {
                                        ...
                                        <Col>
                                            ...
                                            <Form.Control type="text"
                                                onChange={(e) => {
                                                    if (this.state.updateType !== "edit") {
                                                        setFieldValue("groupCode", recordToUpdate.groupCode)
                                                    } else {
                                    ...
                                    <Form.Row>
                                        <Col>
                                            ...
                                            <Form.Control type="text"
                                                onChange={(e) => {
                                                    if (this.state.updateType !== "edit") {
                                                        setFieldValue("employeeNumberLabel", recordToUpdate.employeeNumberLabel)
                                                    } else {
                                                        setFieldValue("employeeNumberLabel", e.target.value)
                                                    }
                                    ...
                                    <div className="footer-with-cta toleft">
                                        <Button
                                            disabled={updateAPayrollGroupReducerRequest.is_request_processing}
                                            variant="secondary" className="grayed-out" onClick={this.handleEditRecordClose}>Cancel</Button>
                                        <Button
                                            type="submit"
                                            disabled={updateAPayrollGroupReducerRequest.is_request_processing}>
                                            {updateAPayrollGroupReducerRequest.is_request_processing && "Please wait..."}
                                            {(!updateAPayrollGroupReducerRequest.is_request_processing && this.state.updateType === "edit") && "Update"}
                                            {(!updateAPayrollGroupReducerRequest.is_request_processing && this.state.updateType === "activate") && "Activate"}
                                            {(!updateAPayrollGroupReducerRequest.is_request_processing && this.state.updateType === "deactivate") && "De-Activate"}
                                        </Button>
                                    </div>
                                </Form>
                            )
                    ...
                    {updateAPayrollGroupReducerRequest.request_status === platformConstants.UPDATE_A_PAYROLLGROUP_SUCCESS &&
                        <Alert variant="success">
                            {updateAPayrollGroupReducerRequest.request_data.response.data.message}
                        </Alert>
                    }
                    {updateAPayrollGroupReducerRequest.request_status === platformConstants.UPDATE_A_PAYROLLGROUP_FAILURE &&
                        <Alert variant="danger">
    ...
    renderContentWrap = () => {
        ...
        let saveRequestData = fetchAllPayrollGroupsRequest.request_data !== undefined ? fetchAllPayrollGroupsRequest.request_data.tempData : null;
...
placeholderText="End  date"
            ...
            case (platformConstants.GET_ALL_PAYROLLGROUP_SUCCESS):
                let allFetchedData = fetchAllPayrollGroupsRequest.request_data.response.data;
...
function mapStateToProps(state) {
    return {
        ...
        fetchAllPayrollGroupsReducer: state.platformReducers.fetchAllPayrollGroupsReducer,
        getAPayrollGroupReducer: state.platformReducers.getAPayrollGroupReducer,
        createAPayrollGroupReducer: state.platformReducers.createAPayrollGroupReducer,
        updateAPayrollGroupReducer: state.platformReducers.updateAPayrollGroupReducer,
