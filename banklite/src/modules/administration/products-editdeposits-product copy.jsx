                        ...
                        <Form className="form-content card">
                          ...
                          <div className="checkbox-wrap">
                            ...
                            <div className="hint-text">
                              A type of deposit where an account is being opened
                              with a certain balance and is fixed for a certain
                              time period with a given interest rate after which
                              point the customer may withdraw their money.
                            </div>
                          </div>
                            ...
                            <Accordion.Collapse eventKey="0">
                              <div>
                                ...
                                <div className="each-formsection branchselection">
                                  ...
                                  <Button className="btn small-btnprimary">
                                    Add Branch
                                  </Button>
                                </div>
                              ...
                              <div>
                                ...
                                <Form.Row>
                                  ...
                                  <Col>
                                    <div className="each-formsection no-margins">
                                      <Form.Label>
                                        When is the Interest Paid Into the
                                        Account?
                                      </Form.Label>
                                      <Form.Control as="select" size="sm">
                                ...
                                <Form.Row>
                                  ...
                                  <Col>
                                    <div className="each-formsection no-margins">
                                      <Form.Label>Days In Year</Form.Label>
                                      <Form.Control as="select" size="sm">
                                        <option value="ACTUAL_365_FIXED">
                                          Actual/365 Fixed (365 days)
                                        </option>
                                        <option value="ACTUAL_360">
                                          Actual/360 (360 days)
                                        </option>
                                        <option value="ACTUAL_ACTUAL_ISDA">
                                          Actual/Actual ISDA
                                        </option>
                                        <option value="E30_360">
                              ...
                              <div>
                                <Form.Row>
                                  <Col>
                                    <Form.Group>
                                      <Form.Label className="block-level">
                                        Default Opening Balance (CFA){" "}
                                      </Form.Label>
                                      <Form.Control type="text" />
                                    </Form.Group>
                                    <Form.Group>
                                      <Form.Label className="block-level">
                                        Min Opening Balance (CFA)
                                      </Form.Label>
                                      <Form.Control type="text" />
                                    </Form.Group>
                                  </Col>
                          ...
                          <Accordion>
                            ...
                            <Accordion.Collapse eventKey="0">
                              <div>
                                <div className="checkbox-wrap">
                                  <input type="checkbox" name="" id="pick-1" />
                                  <label htmlFor="pick-1">
                                    Automatically set accounts as Dormant after
                                  </label>
                                </div>
                                ...
                                <div className="new-fee-wrap">
                                  ...
                                  >
                                    ...
                                    <Col sm={6}>
                                      <Form.Control as="select" size="sm">
                                        <option value="">----------</option>
                                        <option value="110100100">
                                          110100100 - CASH IMPREST - HEAD OFFICE
                                        </option>
                                        <option value="110100101">
                                          110100101 - CASH IMPREST - AKURE
                                        </option>
                                        <option value="110100102">
                                          110100102 - CASH IMPREST - IKEJA
                                        </option>
                                        <option value="110100103">
                                          110100103 - CASH IMPREST - IBADAN
                                        </option>
                                        <option value="110100104">
                                          110100104 - CASH IMPREST - ABUJA
                                        </option>
                                        <option value="110100105">
                                          110100105 - CASH IMPREST - IKORODU
                                        </option>
                                        <option value="110100106">
                                          110100106 - CASH IMPREST - EPE
                                        </option>
                                        <option value="110100107">
                                          110100107 - CASH IMPREST - BADAGRY
                                        </option>
                                        <option value="110101001">
                                          110101001 - INTERBRANCH CASH ACCOUNT
                                          (CMU)
                                        </option>
                                        <option value="110101002">
                                          110101002 - Branch Suspense Account
                                        </option>
                                        <option value="112010001">
                                          112010001 - BALANCE WITH CBN
                                        </option>
                                      </Form.Control>
                                    </Col>
                                    <Col sm={2}>
