...
class PlatformCardProvider extends React.Component {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              this.createNewRecord(requestPayload).then(() => {
                if (
                  this.props.createACardProvider.request_status ===
                  platformConstants.ADD_A_CARDPROVIDER_SUCCESS
                ) {
                  resetForm();
                  this.loadInitialData();
                }
              ...
              return (
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <div className='footer-with-cta toleft'>
                    <Button
                      disabled={
                        createACardProviderRequest.is_request_processing
                      }
                      variant='secondary'
          ...
          {createACardProviderRequest.request_status ===
            platformConstants.ADD_A_CARDPROVIDER_SUCCESS && (
          ...
          {createACardProviderRequest.request_status ===
            platformConstants.ADD_A_CARDPROVIDER_FAILURE && (
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              this.updateARecord(
                ...
                if (
                  this.props.updateACardProvider.request_status ===
                  platformConstants.UPDATE_A_CARDPROVIDER_SUCCESS
                ) {
                  this.loadInitialData();
                }
              });
              ...
              return (
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <div className='footer-with-cta toleft'>
                    <Button
                      disabled={
                        updateACardProviderRequest.is_request_processing
                      }
                      variant='secondary'
                      className='grayed-out'
          ...
          {updateACardProviderRequest.request_status ===
            platformConstants.UPDATE_A_CARDPROVIDER_SUCCESS && (
            <Alert variant='success'>
          ...
          {updateACardProviderRequest.request_status ===
            platformConstants.UPDATE_A_CARDPROVIDER_FAILURE && (
            <Alert variant='danger'>
  ...
  renderContentWrap = () => {
    ...
    let saveRequestData =
      fetchAllCardProviderRequest.request_data !== undefined
        ? fetchAllCardProviderRequest.request_data.tempData
        : null;
    ...
    switch (fetchAllCardProviderRequest.request_status) {
      ...
      case platformConstants.GET_ALL_CARDPROVIDER_SUCCESS:
        let allFetchedData =
          fetchAllCardProviderRequest.request_data.response.data;
