...
class ProductDeposits extends React.Component {
  ...
  renderDepositProducts = () => {
    ...
    let saveRequestData =
      getDepositProductsRequestData.request_data !== undefined
        ? getDepositProductsRequestData.request_data.tempData
        : null;

    if (
      getDepositProductsRequestData.request_status ===
      productsConstants.GET_DEPOSIT_PRODUCTS_PENDING
    ) {
      if (
        ...
        return (
          <div>
                      ...
                      <tr>
                        <td>
                          <NavLink
                            ...
                            to={`/administration/products/deposit/edit/${eachDepositProduct.productEncodedKey}`}
                          >
                            {eachDepositProduct.productName}
                          </NavLink>
                        </td>
                        <td>{eachDepositProduct.currencyCode}</td>
                        <td>{eachDepositProduct.productCode}</td>
                        <td>
                          {eachDepositProduct.depositAccountTypeDescription}
                        </td>
                        <td>{eachDepositProduct.lastModified}</td>
                        <td>
                          {eachDepositProduct.isActive.toString() === "true"
                            ? "Active"
                            : "Not Active"}
                        </td>
                      </tr>
            ...
            <div className="footer-with-cta toleft">
              <NavLink
                to={"/administration/products/newdeposits-product"}
    ...
    if (
      getDepositProductsRequestData.request_status ===
      productsConstants.GET_DEPOSIT_PRODUCTS_SUCCESS
    ) {
      let allDepositProductsData =
        getDepositProductsRequestData.request_data.response.data;
            ...
            <div>
              ...
              <div className="table-helper mb-10">
                <input
                  ...
                  name=""
                  onChange={(e) =>
                    this.setShowDetails(e, allDepositProductsData.result)
                  }
              ...
              <TableComponent classnames="striped bordered hover">
                ...
                <tbody>
                  {allDepositProductsData.result.map(
                    (eachDepositProduct, index) => {
                      return (
                        <Fragment key={index}>
                          <tr>
                            <td>
                              <NavLink
                                to={`/depositproduct/${eachDepositProduct.productEncodedKey}`}
                              >
                                {eachDepositProduct.productName}
                              </NavLink>
                            </td>
    ...
    if (
      getDepositProductsRequestData.request_status ===
      productsConstants.GET_DEPOSIT_PRODUCTS_FAILURE
    ) {
      return (
