...
class NewDepositsProduct extends React.Component {
  ...
  handleCreateNewDepositProduct = async (newDepositProductPayload) => {
    ...
    await dispatch(
      productActions.createDepositProduct(newDepositProductPayload)
    );
  };
  ...
  renderCreateDepositProduct = () => {
    ...
    let allProductTypes = [
      ...
      },
      {
        ...
        desc:
          "A type of account used for investing funds in other borrowers loan accounts. The customer earns interest after loan investments, instead of the traditional interest paid into account by the organization.",
      },
      {
        value: "4",
    ...
    if (
      ...
      if (
        getAllGLAccountsRequest.request_data.response.data.length >= 0 &&
          ...
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              let createNewDepositProductPayload = {
                ...
                depositProductAccountingRule: {
                  savingsControlAccountId:
                    values.savingsControlAccountId !== ""
                      ...
                      : null,
                  transactionSourceAccountId:
                    values.transactionSourceAccountId !== ""
                      ? values.transactionSourceAccountId
                      : null,
                  interestExpenseAccountId:
                    values.interestExpenseAccountId !== ""
                      ? values.interestExpenseAccountId
                      : null,
                  interestPayableAccountId:
                    values.interestPayableAccountId !== ""
                      ? values.interestPayableAccountId
                      : null,
                  feeIncomeAccountId:
                ...
                currencyCode:
                  values.currencyCode !== "" ? values.currencyCode : null,
              ...
              this.handleCreateNewDepositProduct(
                createNewDepositProductPayload
              ).then(() => {
                if (
                  this.props.createDepositProductReducer.request_status ===
                  productsConstants.CREATE_A_DEPOSIT_PRODUCT_SUCCESS
                ) {
                  setTimeout(() => {
                    resetForm();
                    this.props.dispatch(
                      productActions.createDepositProduct("CLEAR")
                    );
                  }, 3000);
                } else {
                  // setTimeout(() => {
            ...
            {({
              ...
              >
                      ...
                      defaultValue={{
                        label:
                          allProductTypes !== null
                            ? allProductTypes[0].label
                            : null,
                        value:
                          allProductTypes !== null
                            ? allProductTypes[0].value
                            : null,
                      }}
                      onChange={(selected) => {
                ...
                <div className="checkbox-wrap">
                  ...
                  <div className="hint-text">{this.state.typeDesc}</div>
                </div>
                            ...
                            defaultValue={{
                              label:
                                methodologyList !== null
                                  ? methodologyList[0].label
                                  : null,
                              value:
                                methodologyList !== null
                                  ? methodologyList[0].value
                                  : null,
                            }}
                            onChange={(selected) =>
                ...
                <div className="footer-with-cta toleft">
                  <NavLink
                    to={"/administration/products/deposits"}
                  ...
                  >
                    {createDepositProductRequest.is_request_processing
                      ? "Please wait..."
                      : "Create Product"}
                  </Button>
                </div>
                {createDepositProductRequest.request_status ===
                  productsConstants.CREATE_A_DEPOSIT_PRODUCT_SUCCESS && (
                  <Alert variant="success">
                    {
                      createDepositProductRequest.request_data.response.data
                        .message
                    }
                  </Alert>
                )}
                {createDepositProductRequest.request_status ===
                  productsConstants.CREATE_A_DEPOSIT_PRODUCT_FAILURE && (
...
function mapStateToProps(state) {
  return {
    createDepositProductReducer:
      state.productReducers.createDepositProductReducer,
