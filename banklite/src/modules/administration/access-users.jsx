...
class AccessUsers extends React.Component {
  ...
  handleUserStateUpdates = async (activationAction, userStatePayload) => {
    ...
    await dispatch(
      authActions.activateDeactivateUser(activationAction, userStatePayload)
    );
  };
  ...
  resetUserPIN = (resetPINPayload, userToResetPInFor) => {
    ...
    this.handleResetPINUpdates(resetPINPayload)
      .then(() => {
        if (
          this.props.ResetPinReducer.request_status ===
  ...
  resetUserPassword = (resetPasswordPayload, userToResetPasswordFor) => {
    ...
    this.handleResetPasswordUpdates(resetPasswordPayload)
      .then(() => {
        if (
          this.props.ResetPasswordReducer.request_status ===
  ...
  activateDeactivateUser = (
    ...
    this.handleUserStateUpdates(activationAction, userActionPayload)
      .then(() => {
        if (
          this.props.ActivateDeactivateUserReducer.request_status ===
  ...
  renderAllUsers = () => {
    ...
    let saveRequestData =
      adminGetUsersRequest.request_data !== undefined
        ? adminGetUsersRequest.request_data.tempData
        : null;
...
<span className="invalid-feedback">{errors.startDate}</span>
  ...
  handleshowResetPasswordStatus = () =>
    this.setState({ showResetPasswordStatus: true });
  ...
  handleshowActivationtatus = () =>
    this.setState({ showActivationStatus: true });
  ...
  PINResetStatus = () => {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          {ResetPinRequest.request_status ===
  ...
  PasswordesetStatus = () => {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          {ResetPasswordRequest.request_status ===
          ...
          {ResetPasswordRequest.request_status ===
            authConstants.RESET_PASSWORD_PENDING && (
            <div className='text-center '>
  ...
  ActivationActionStatus = () => {
    ...
    let ActivateDeactivateUserRequest = this.props
      .ActivateDeactivateUserReducer;

    return (
      <Modal
        show={showActivationStatus}
        onHide={() => {}}
        size='lg'
        centered='true'
        dialogClassName='modal-40w withcentered-heading'
      ...
      >
        ...
        <Modal.Body>
          {ActivateDeactivateUserRequest.request_status ===
