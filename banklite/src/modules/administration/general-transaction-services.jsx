...
class TransactionServices extends React.Component {
  ...
  handleCloseNewRecord = () => {
    ...
    if (
      this.props.createAChannelServices.request_status ===
      administrationConstants.ADD_A_CHANNEL_SERVICE_SUCCESS
    ) {
      this.loadInitialData();
    }
  };
  ...
  handleEditRecordClose = () => {
    ...
    if (
      this.props.updateAChannelServices.request_status ===
      administrationConstants.UPDATE_A_CHANNEL_SERVICE_SUCCESS
    ) {
      this.loadInitialData();
    }
  };
  ...
  createNewRecordPopUp = () => {
    ...
    let fetchAllChannelServicesRequest = this.props
        .fetchAllChannelServicesReducer,
      allGlAccounts =
        fetchAllChannelServicesRequest.request_data.response2.data;
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              let requestPayload = {
                ...
                maxServiceCommissionValue: parseFloat(
                  values.maxServiceCommissionValue.replace(/,/g, '')
                ),
                serviceCommisionCalculation: parseInt(
                  values.serviceCommisionCalculation
                ),
                serviceCommission: parseFloat(
                  values.serviceCommission.replace(/,/g, '')
                ),
                serviceCommisionGLAcccountId: parseInt(
                  values.serviceCommisionGLAcccountId
                ),
              };
              ...
              return (
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <Form.Row>
                    <Col>
                      <Form.Label className='block-level'>
                        Max Service Commission
                      </Form.Label>
                      <Form.Control
                        type='text'
                        onChange={handleChange}
                        value={numberWithCommas(
                          values.maxServiceCommissionValue
                        )}
                        className={
                          errors.maxServiceCommissionValue &&
                          touched.maxServiceCommissionValue
                            ? 'is-invalid h-38px'
                            : 'h-38px'
                        }
                    ...
                    <Col>
                      ...
                      <select
                        ...
                        className={
                          errors.serviceCommisionCalculation &&
                          touched.serviceCommisionCalculation
                  ...
                  <Form.Row>
                    ...
                    <Col>
                      ...
                      <Select
                        ...
                        className={
                          errors.serviceCommisionGLAcccountId &&
                          touched.serviceCommisionGLAcccountId
                            ? 'is-invalid'
                            : null
                        }
                  ...
                  <div className='footer-with-cta toleft'>
                    <Button
                      disabled={
                        createAChannelServicesRequest.is_request_processing
                      }
                      variant='secondary'
          ...
          {createAChannelServicesRequest.request_status ===
            administrationConstants.ADD_A_CHANNEL_SERVICE_SUCCESS && (
          ...
          {createAChannelServicesRequest.request_status ===
            administrationConstants.ADD_A_CHANNEL_SERVICE_FAILURE && (
  ...
  updateARecord = async (payload, encodedKey) => {
    ...
    await dispatch(
      administrationActions.updateAChannelServices(payload, encodedKey)
    );
  };
  ...
  updateRecordPopUp = (updateType) => {
    ...
    filteredData = allAccountsList.filter(
      (eachData) =>
        ...
        <Modal.Body>
          <Formik
            initialValues={{
              ...
              maxServiceCommissionValue:
                recordToUpdate.maxServiceCommissionValue,
              serviceCommisionCalculation:
                recordToUpdate.serviceCommisionCalculation,
              serviceCommission: recordToUpdate.serviceCommission,
              serviceCommisionGLAcccountId:
                recordToUpdate.serviceCommisionGLAcccountId,
            }}
            validationSchema={checkValidationSchema}
            onSubmit={(values, { resetForm }) => {
              // same shape as initial values
              ...
              return (
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <Form.Row>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => {
                          if (this.state.updateType !== 'edit') {
                            setFieldValue(
                              'serviceCommission',
                              recordToUpdate.serviceCommission
                            );
                          } else {
                    ...
                    <Col>
                      ...
                      <Select
                        ...
                        defaultValue={{
                          label:
                            filteredData !== null ? filteredData.label : null,
                          value:
                            filteredData !== null ? filteredData.value : null,
                        }}
                        onChange={(selectedAccount) => {
                          if (this.state.updateType !== 'edit') {
                            setFieldValue(
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        if (this.state.updateType !== 'edit') {
                          setFieldValue(
                            'serviceDescription',
                            recordToUpdate.serviceDescription
                          );
                        } else {
                  ...
                  <div className='footer-with-cta toleft'>
                    <Button
                      disabled={
                        updateAChannelServicesRequest.is_request_processing
                      }
                      variant='secondary'
                      className='grayed-out'
          ...
          {updateAChannelServicesRequest.request_status ===
            administrationConstants.UPDATE_A_CHANNEL_SERVICE_SUCCESS && (
            <Alert variant='success'>
          ...
          {updateAChannelServicesRequest.request_status ===
            administrationConstants.UPDATE_A_CHANNEL_SERVICE_FAILURE && (
            <Alert variant='danger'>
  ...
  renderContentWrap = () => {
    ...
    let saveRequestData =
      fetchAllChannelServicesRequest.request_data !== undefined
        ? fetchAllChannelServicesRequest.request_data.tempData
        : null;
    ...
    switch (fetchAllChannelServicesRequest.request_status) {
                    ...
                    return (
                      <Fragment key={index}>
                        <tr>
                          ...
                          <td>
                            {eachItem.serviceCommisionCalculationDescription}
                          </td>
                          <td>
                            {numberWithCommas(eachItem.serviceCommission, true)}
                          </td>
                          <td>
                            {numberWithCommas(
                              eachItem.maxServiceCommissionValue,
                              true
                            )}
                          </td>
      ...
      case administrationConstants.GET_ALL_CHANNEL_SERVICE_SUCCESS:
        let allFetchedData =
          fetchAllChannelServicesRequest.request_data.response.data;
