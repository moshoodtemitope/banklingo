                            ...
                            onSubmit={(values, { resetForm }) => {
                                ...
                                let updateLoanProductPayload = {
                                    ...
                                    loanProductAccountingRuleModel :{
                                        id:0,
                                        portfolioControlAccountId: parseInt(values.portfolioControlAccountId) || null,
                                        transactionSourceAccountId: parseInt(values.transactionSourceAccountId) ||null,
                                        writeOffExpenseAccountId: parseInt(values.writeOffExpenseAccountId)|| null,
                                        interestReceivableAccountId: parseInt(values.interestReceivableAccountId) ||null,
                                        feeReceivableAccountId: parseInt(values.feeReceivableAccountId) || null,
                                        penaltyReceivableAccountId: parseInt(values.penaltyReceivableAccountId) || null,
                                        feeIncomeAccountId: parseInt(values.feeIncomeAccountId) || null,
                                        interestIncomeAccountId: parseInt(values.interestIncomeAccountId) || null,
                                        penaltyIncomeAccountId: parseInt(values.penaltyIncomeAccountId) || null,
                                    },
                                    arrearsSetting: {
                                        arearsTolerancePeriodInDaysDefault: parseInt(values.arearsTolerancePeriodInDaysDefault) || null,
                                        arrearsDaysCalculatedFrom: parseInt(values.arrearsDaysCalculationChosen) || null,
                                        arearsTolerancePeriodInDaysMin: parseInt(values.arearsTolerancePeriodInDaysMin) || null,
                                        arearsTolerancePeriodInDaysMax: parseInt(values.arearsTolerancePeriodInDaysMax) ||null
                                    },
                                    ...
                                    loanAmountSetting: {
                                        ...
                                        loanAmountMinimun: values.minimumLoanAmount? parseFloat(values.minimumLoanAmount.toString().replace(/,/g, '')) : null,
                                        loanAmountMaximum: values.maximumLoanAmount? parseFloat(values.maximumLoanAmount.toString().replace(/,/g, '')) : null
                                    },

                                    repaymentReschedulingModel: {
                                        repaymentEvery: values.repaymentEvery? parseInt(values.repaymentEvery) : null,
                                        repaymentPeriod: values.repaymentPeriod? parseInt(values.repaymentPeriod) : null,
                                        interestBalanceCalculation: values.interestBalanceCalculationSelected? parseInt(values.interestBalanceCalculationSelected) :null,
                                        firstDueDateOffsetConstraintDefault: values.firstDueDateOffsetConstraintDefault? parseInt(values.firstDueDateOffsetConstraintDefault):null,
                                        firstDueDateOffsetConstraintMin:values.firstDueDateOffsetConstraintMin?  parseInt(values.firstDueDateOffsetConstraintMin) :null,
                                        firstDueDateOffsetConstraintMax: values.firstDueDateOffsetConstraintMax? parseInt(values.firstDueDateOffsetConstraintMax) : null,
                                        installmentsDefault: values.installmentsDefault? parseFloat(values.installmentsDefault.toString().replace(/,/g, '')) : null,
                                        installmentsMin: values.installmentsMin? parseFloat(values.installmentsMin.toString().replace(/,/g, '')) : null,
                                        installmentsMax: values.installmentsMax? parseFloat(values.installmentsMax.toString().replace(/,/g, '')) : null,
                                        collectPrincipalEveryRepayments: values.collectPrincipalEveryRepayments? parseInt(values.collectPrincipalEveryRepayments) : null
                                    },
