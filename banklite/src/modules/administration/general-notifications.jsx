...
class Notifications extends React.Component {
    ...
    clearAllData = () => {
        this.props.dispatch(administrationActions.createANotificationTemplate("CLEAR"));
        this.props.dispatch(administrationActions.updateANotificationTemplate("CLEAR"));
    }
    ...
    setPagesize = (PageSize, tempData) => {
        ...
        if (tempData) {
            dispatch(administrationActions.fetchAllNotificationTemplate(params, tempData));
        } else {
    ...
    handleCloseNewRecord = () => {
        if (this.props.createANotificationTemplate.is_request_processing === false) {
    ...
    handleEditRecordClose = () => {
        if (this.props.updateANotificationTemplate.is_request_processing === false) {
    ...
    createNewRecordPopUp = () => {
        ...
        let createANotificationTemplateRequest = this.props.createANotificationTemplate;
        ...
        return (
            <Modal show={showCreateNewRecord} onHide={this.handleCloseNewRecord} size="lg" centered="true" dialogClassName="modal-40w withcentered-heading" animation={true}>
                ...
                <Modal.Body>
                    <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                            ...
                            this.createNewRecord(requestPayload)
                                .then(
                                    () => {
                                        if (this.props.createANotificationTemplate.request_status === administrationConstants.ADD_A_NOTIFICATION_TEMPLATE_SUCCESS) {
                                            resetForm();
                                            this.loadInitialData();
                                        }
                            ...
                            return (
                                <Form noValidate
                                    ...
                                    <Form.Row>
                                        ...
                                        <Col>
                                            <Form.Label className="block-level">Template name</Form.Label>
                                        ...
                                        <Col>
                                            <Form.Label className="block-level">Template Key</Form.Label>
                                            <Form.Control type="text"
                                                onChange={handleChange}
                                                value={values.key}
                                                className={errors.key && touched.key ? "is-invalid h-38px" : "h-38px"}
                                                name="key"
                                                required />
                                    ...
                                    <Form.Row>
                                        ...
                                        <Col>
                                            <Form.Label className="block-level">Template Source</Form.Label>
                                            <Form.Control type="text"
                                                onChange={handleChange}
                                                value={values.notificationTemplatesSource}
                                                className={errors.notificationTemplatesSource && touched.notificationTemplatesSource ? "is-invalid h-38px" : "h-38px"}
                                                name="notificationTemplatesSource"
                                                required />

                                            {errors.notificationTemplatesSource && touched.notificationTemplatesSource ? (
                                                <span className="invalid-feedback">{errors.notificationTemplatesSource}</span>
                                            ) : null}

                                        </Col>
                                        <Col>
                                            <Form.Label className="block-level">Communication Type</Form.Label>
                                            <select id="toshow"
                                                name="communicationType"
                                                onChange={handleChange}
                                                value={values.communicationType}
                                                className={errors.communicationType && touched.communicationType ? "form-control form-control-sm is-invalid h-38px" : "form-control form-control-sm h-38px"}
                                            >
                                            ...
                                            {errors.communicationType && touched.communicationType ? (
                                                <span className="invalid-feedback">{errors.communicationType}</span>
                                            ) : null}
                                    ...
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            className={errors.messageTemplate && touched.messageTemplate ? "is-invalid" : null}
                                            name="messageTemplate"
                                        />

                                        {errors.messageTemplate && touched.messageTemplate ? (
                                            <span className="invalid-feedback">{errors.messageTemplate}</span>
                                        ) : null}
                                    </Form.Group>

                                    <div className="footer-with-cta toleft">
                                        <Button
                                            disabled={createANotificationTemplateRequest.is_request_processing}
                                            variant="secondary" className="grayed-out" onClick={this.handleCloseNewRecord}>Cancel</Button>
                                        <Button
                                            type="submit"
                                            disabled={createANotificationTemplateRequest.is_request_processing}>
                                            {createANotificationTemplateRequest.is_request_processing ? "Please wait..." : "Create"}
                                        </Button>
                                    </div>
                                </Form>
                            )
                    ...
                    {createANotificationTemplateRequest.request_status === administrationConstants.ADD_A_NOTIFICATION_TEMPLATE_SUCCESS &&
                        <Alert variant="success">
                            {createANotificationTemplateRequest.request_data.response.data.message}
                        </Alert>
                    }
                    {createANotificationTemplateRequest.request_status === administrationConstants.ADD_A_NOTIFICATION_TEMPLATE_FAILURE &&
    ...
    updateARecord = async (payload, encodedKey) => {
        ...
        await dispatch(administrationActions.updateANotificationTemplate(payload, encodedKey));
    ...
    updateRecordPopUp = (updateType) => {
        ...
        let updateANotificationTemplateRequest = this.props.updateANotificationTemplate;
        ...
        return (
            <Modal show={showEditRecord} onHide={this.handleEditRecordClose} size="lg" centered="true" dialogClassName="modal-40w withcentered-heading" animation={true}>
                ...
                <Modal.Body>
                    <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                            ...
                            this.updateARecord(requestPayload, recordToUpdate.encodedKey)
                                .then(
                                    () => {
                                        if (this.props.updateANotificationTemplate.request_status === administrationConstants.UPDATE_A_NOTIFICATION_TEMPLATE_SUCCESS) {
                                ...
                                <Form noValidate
                                    ...
                                    <Form.Row>
                                        ...
                                        <Col>
                                            ...
                                            <Form.Control type="text"
                                                onChange={(e) => {
                                                    if (this.state.updateType !== "edit") {
                                                        setFieldValue("notificationTemplatesSource", recordToUpdate.notificationTemplatesSource)
                                                    } else {
                                                        setFieldValue("notificationTemplatesSource", e.target.value)
                                                    }
                                        ...
                                        <Col>
                                            ...
                                            <select id="toshow"
                                                ...
                                                onChange={(e) => {
                                                    if (this.state.updateType !== "edit") {
                                                        setFieldValue("communicationType", recordToUpdate.communicationType)
                                                    } else {
                                    ...
                                    <Form.Group>
                                        ...
                                        <Form.Control
                                            ...
                                            onChange={(e) => {
                                                if (this.state.updateType !== "edit") {
                                                    setFieldValue("messageTemplate", recordToUpdate.messageTemplate)
                                                } else {
                                    ...
                                    <div className="footer-with-cta toleft">
                                        <Button
                                            disabled={updateANotificationTemplateRequest.is_request_processing}
                                            variant="secondary" className="grayed-out" onClick={this.handleEditRecordClose}>Cancel</Button>
                                        <Button
                                            type="submit"
                                            disabled={updateANotificationTemplateRequest.is_request_processing}>
                                            {updateANotificationTemplateRequest.is_request_processing && "Please wait..."}
                                            {(!updateANotificationTemplateRequest.is_request_processing && this.state.updateType === "edit") && "Update"}
                                            {(!updateANotificationTemplateRequest.is_request_processing && this.state.updateType === "activate") && "Activate"}
                                            {(!updateANotificationTemplateRequest.is_request_processing && this.state.updateType === "deactivate") && "De-Activate"}
                                        </Button>
                                    </div>
                                </Form>
                            )
                    ...
                    {updateANotificationTemplateRequest.request_status === administrationConstants.UPDATE_A_NOTIFICATION_TEMPLATE_SUCCESS &&
                        <Alert variant="success">
                            {updateANotificationTemplateRequest.request_data.response.data.message}
                        </Alert>
                    }
                    {updateANotificationTemplateRequest.request_status === administrationConstants.UPDATE_A_NOTIFICATION_TEMPLATE_FAILURE &&
                        <Alert variant="danger">
    ...
    renderContentWrap = () => {
        let fetchAllNotificationTemplateRequest = this.props.fetchAllNotificationTemplate;
        
        let saveRequestData = fetchAllNotificationTemplateRequest.request_data !== undefined ? fetchAllNotificationTemplateRequest.request_data.tempData : null;
...
placeholderText="End  date"
            ...
            case (administrationConstants.GET_ALL_NOTIFICATION_TEMPLATE_SUCCESS):
                let allFetchedData = fetchAllNotificationTemplateRequest.request_data.response.data;
...
function mapStateToProps(state) {
    return {
        fetchAllNotificationTemplate : state.administrationReducers.fetchAllNotificationTemplate,
        getANotificationTemplate : state.administrationReducers.getANotificationTemplate,
        createANotificationTemplate : state.administrationReducers.createANotificationTemplate,
        updateANotificationTemplate : state.administrationReducers.updateANotificationTemplate,
    };
}
