...
class UserAccountContainer extends React.Component {
    ...
    renderUserDetailsHeading = ()=>{
        ...
        if(adminGetAUserRequest.request_status===administrationConstants.GET_A_USER_PENDING){
        ...
        if(adminGetAUserRequest.request_status===administrationConstants.GET_A_USER_FAILURE){

            return(
                <div className="loading-text errormsg"> {adminGetAUserRequest.request_data.error}</div>
            )
        }
