...
class DepositProductInfoContainer extends React.Component {
        ...
        return(
            <div className="module-submenu">
                <div className="content-container">
                    <ul className="nav">
                        <li>
                            <NavLink exact to={generatedRoutes.product}>Overview</NavLink>
                        </li>
                    </ul>
            ...
            <div className="content-container">
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="">
                            <h2>
                                {(productDetails.productName!==null && productDetails.productName!=="")?
    ...
    renderProductDetailsHeading = ()=>{
        let getSingleDepositProductsRequest = this.props.getSingleDepositProductsReducer;


        if(getSingleDepositProductsRequest.request_status===productsConstants.GET_A_DEPOSIT_PRODUCT_PENDING){
        ...
        if(getSingleDepositProductsRequest.request_status===productsConstants.GET_A_DEPOSIT_PRODUCT_SUCCESS){
                
                // console.log("dsdsdsdsd", getSingleDepositProductsRequest);
                let productDetails = getSingleDepositProductsRequest.request_data.response.data;
        ...
        if(getSingleDepositProductsRequest.request_status===productsConstants.GET_A_DEPOSIT_PRODUCT_FAILURE){
            ...
            return(
                <div className="loading-text errormsg"> {getSingleDepositProductsRequest.request_data.error}</div>
            )
        }
             ...
             <Fragment>
                <InnerPageContainer {...this.props}>
                    <div className="content-wrapper">
                        ...
                        {this.props.children}
                        <Route exact to='/depositproduct/:productid'  component={DepositProductContainer} /> 
