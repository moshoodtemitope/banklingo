...
function confirmTenant(tenantPayload) {
  ...
  function request(user) {
    return { type: authConstants.GET_TENANCY_PENDING, user };
  }
  function success(response) {
    return { type: authConstants.GET_TENANCY_SUCCESS, response };
  }
  function failure(error) {
    return { type: authConstants.GET_TENANCY_FAILURE, error };
  }
  function clear() {
    return { type: authConstants.GET_TENANCY_RESET, clear_data: "" };
  }
}
...
function ResfreshToken(refreshTokenPayload) {
  ...
  function request(user) {
    return { type: authConstants.REFRESH_TOKEN_PENDING, user };
  }
  function success(response) {
    return { type: authConstants.REFRESH_TOKEN_SUCCESS, response };
  }
  function failure(error) {
    return { type: authConstants.REFRESH_TOKEN_FAILURE, error };
  }
  function clear() {
    return { type: authConstants.REFRESH_TOKEN_RESET, clear_data: "" };
  }
}
...
function ChangePassword(changePasswordPayload) {
  ...
  function request(user) {
    return { type: authConstants.CHANGE_PASSWORD_PENDING, user };
  }
  function success(response) {
    return { type: authConstants.CHANGE_PASSWORD_SUCCESS, response };
  }
  function failure(error) {
    return { type: authConstants.CHANGE_PASSWORD_FAILURE, error };
  }
  function clear() {
    return { type: authConstants.CHANGE_PASSWORD_RESET, clear_data: "" };
  }
}
...
function ChangePIN(changePINPayload) {
  ...
  function request(user) {
    return { type: authConstants.CHANGE_PIN_PENDING, user };
  }
  function success(response) {
    return { type: authConstants.CHANGE_PIN_SUCCESS, response };
  }
  function failure(error) {
    return { type: authConstants.CHANGE_PIN_FAILURE, error };
  }
  function clear() {
    return { type: authConstants.CHANGE_PIN_RESET, clear_data: "" };
  }
}
...
function ResetPIN(resetPINPayload) {
  ...
  function request(user) {
    return { type: authConstants.RESET_PIN_PENDING, user };
  }
  function success(response) {
    return { type: authConstants.RESET_PIN_SUCCESS, response };
  }
  function failure(error) {
    return { type: authConstants.RESET_PIN_FAILURE, error };
  }
  function clear() {
    return { type: authConstants.RESET_PIN_RESET, clear_data: "" };
  }
}
...
function ResetPassword(resetPasswordPayload) {
  ...
  function request(user) {
    return { type: authConstants.RESET_PASSWORD_PENDING, user };
  }
  function success(response) {
    return { type: authConstants.RESET_PASSWORD_SUCCESS, response };
  }
  function failure(error) {
    return { type: authConstants.RESET_PASSWORD_FAILURE, error };
  }
  function clear() {
    return { type: authConstants.RESET_PASSWORD_RESET, clear_data: "" };
  }
}
