...
const administrationReducers = combineReducers({
  ...
  adminGetOrganizationDetailsReducer:
    administration.getOrganizationDetailsReducer,
  adminUpdateOrganizationDetailsReducer:
    administration.updateOrganizationDetailsReducer,
  ...
  adminGetTransactionChannelsReducer:
    administration.getTransactionChannelsReducer,
  adminCreateTransactionChannelReducer:
    administration.createTransactionChannelReducer,
  adminUpdateTransactionChannelReducer:
    administration.updateTransactionChannelReducer,
  ...
  adminSetCurrencyConversionRateReducer:
    administration.setCurrencyConversionRateReducer,
...
const depositsReducers = combineReducers({
  ...
  getAccountDepositTransactionReducer:
    deposits.getAccountDepositTransactionReducer,
  ...
  getADepositAccountActivitiesReducer:
    deposits.getADepositAccountActivitiesReducer,
  getADepositAccountCommunicationsReducer:
    deposits.getADepositAccountCommunicationsReducer,
  getAClientDepositAccountCommentsReducer:
    deposits.getAClientDepositAccountCommentsReducer,
  createADepositCommentReducer: deposits.createADepositCommentReducer,
  getADepositAccountAttachmentsReducer:
    deposits.getADepositAccountAttachmentsReducer,
...
const loansReducers = combineReducers({
  ...
  getAClientLoanAccountScheduleReducer:
    loans.getAClientLoanAccountScheduleReducer,
  getAClientLoanAccountCommentsReducer:
    loans.getAClientLoanAccountCommentsReducer,
  ...
  getALoanAccountCommunicationsReducer:
    loans.getALoanAccountCommunicationsReducer,
...
const platformReducers = combineReducers({
  ...
  fetchSingleCreditScoreByPassReducer:
    platform.fetchSingleCreditScoreByPassReducer,
...
const disbursmentReducers = combineReducers({
  ...
  getPendingApprovalDisbursementReducer:
    disbursment.getPendingApprovalDisbursementReducer,
  getPendingReviewDisbursementReducer:
    disbursment.getPendingReviewDisbursementReducer,
  ...
  performActionOnDisbursementBatchReducer:
    disbursment.performActionOnDisbursementBatchReducer,
  getInitiatedDisbursementsReducer:
    disbursment.getInitiatedDisbursementsReducer,
  approveOrRejectPostDisbursementReducer:
    disbursment.approveOrRejectPostDisbursementReducer,
  deleteADisbursementReducer: disbursment.deleteADisbursementReducer,
  approveOrRejectReviewedDisbursementReducer:
    disbursment.approveOrRejectReviewedDisbursementReducer,
